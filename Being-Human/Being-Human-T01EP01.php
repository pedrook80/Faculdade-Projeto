...
<link href="css/bootstrap(being-human) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Being Human T01EP01</title>
<script>
...
<div class="container"> 
  <!-- Header -->
  <header class="header">
	  <h4 class="logo"><a href="http:www.viaserie.tk/.php">VIA SÉRIE</a></h4>
  </header>
 <div class=" menu-item-43">
  ...
  <div class="gallery">
     	<div class="thumbnail">
      	<!--<div class="options">
        <ul id="options">
          <!--<li><a href="https://ok.ru/videoembed/200137312922?rel=0&autoplay=1" target="video1"> OPÇÃO 1</a></li>
      </ul>
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer07/ondemand/.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
     	...
     	<video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      	<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=c51208fb11e5ea4a&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1486225501&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=404092FF21CEBA731CFF6A7E69396C4B006882E5.4766C2AA89B4439EF2E0684C05325D305A9D6134&key=ck2"/>
      	<source type="video/mp4" src="" data-quality="hd"/>
		</video>
        <h4>Being Human T01EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
