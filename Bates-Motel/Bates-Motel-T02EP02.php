...
<title>Bates Motel T02EP02</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="options">
        <ul id="options">
          <li><a href="https://ok.ru/videoembed/33082378937?rel=0&autoplay=1" target="video1.php"> OPÇÃO 1</a></li>
      </ul>
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer09/ondemand/BATMTLT02EP02.mp4?rel=0&autoplay=1" target="video1.php"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	<iframe name="video1" id="video1" class="cards" width="500px" src="" frameborder="1" allowfullscreen></iframe>      
        <h4>Bates Motel T02EP02</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
