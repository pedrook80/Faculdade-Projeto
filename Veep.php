...
<title>Veep</title>
<link href="css/bootstrap(veep).css" rel="stylesheet" type="text/css">
</head>
<body>	
<!-- Main Container -->
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Veep.php"><img src="images/veep.jpg" alt="" width="2000" class="cards"/></a>
      	<h4>VEEP</h4>
      	<p class="tag">A senadora Selina Meyer (Julia Louis-Dreyfus) integra a chapa que conquista a eleição presidencial norte-americana e assume o posto de vice-presidente dos Estados Unidos. Porém descobre que este trabalho está longe de ser o que ela tinha imaginado.</p>
      	<p>Criado por: Armando Iannucci (2012)</p>
		<p>Gênero: Comédia</p>
		<p>País: EUA</p>
		<p>Atores: Julia Louis-Dreyfus, Anna Chlumsky, Tony Hale, mais...</p>
		<p>Status: Em produção</p>
		<p>Duração: 26 minutos</p>
		<div class="ver"></div>
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
			<div id="epsetemps">
        		<ul class="temps" id="temp1">
            <li><a href="#" class="text">Veep T01EP01</a></li>
            <li><a href="#" class="text">Veep T01EP02</a></li>
            <li><a href="#" class="text">Veep T01EP03</a></li>
            <li><a href="#" class="text">Veep T01EP04</a></li>
            <li><a href="#" class="text">Veep T01EP05</a></li>
            <li><a href="#" class="text">Veep T01EP06</a></li>
            <li><a href="#" class="text">Veep T01EP07</a></li>
            <li><a href="#" class="text">Veep T01EP08</a></li>
            <li><a href="#" class="text">Veep T01EP09</a></li>
            <li><a href="#" class="text">Veep T01EP10</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="#" class="text">Veep T02EP01</a></li>
            <li><a href="#" class="text">Veep T02EP02</a></li>
            <li><a href="#" class="text">Veep T02EP03</a></li>
            <li><a href="#" class="text">Veep T02EP04</a></li>
            <li><a href="#" class="text">Veep T02EP05</a></li>
            <li><a href="#" class="text">Veep T02EP06</a></li>
            <li><a href="#" class="text">Veep T02EP07</a></li>
            <li><a href="#" class="text">Veep T02EP08</a></li>
            <li><a href="#" class="text">Veep T02EP09</a></li>
            <li><a href="#" class="text">Veep T02EP10</a></li>
                </ul></div>
			<h3 class="heading"><span>3ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="#" class="text">Veep T03EP01</a></li>
            <li><a href="#" class="text">Veep T03EP02</a></li>
            <li><a href="#" class="text">Veep T03EP03</a></li>
            <li><a href="#" class="text">Veep T03EP04</a></li>
            <li><a href="#" class="text">Veep T03EP05</a></li>
            <li><a href="#" class="text">Veep T03EP06</a></li>
            <li><a href="#" class="text">Veep T03EP07</a></li>
            <li><a href="#" class="text">Veep T03EP08</a></li>
            <li><a href="#" class="text">Veep T03EP09</a></li>
            <li><a href="#" class="text">Veep T03EP10</a></li>
            </ul></div>
            <h3 class="heading"><span>4ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="#" class="text">Veep T04EP01</a></li>
            <li><a href="#" class="text">Veep T04EP02</a></li>
            <li><a href="#" class="text">Veep T04EP03</a></li>
            <li><a href="#" class="text">Veep T04EP04</a></li>
            <li><a href="#" class="text">Veep T04EP05</a></li>
            <li><a href="#" class="text">Veep T04EP06</a></li>
            <li><a href="#" class="text">Veep T04EP07</a></li>
            <li><a href="#" class="text">Veep T04EP08</a></li>
            <li><a href="#" class="text">Veep T04EP09</a></li>
            <li><a href="#" class="text">Veep T04EP10</a></li>
            </ul></div>
            <h3 class="heading"><span>5ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="#" class="text">Veep T05EP01</a></li>
            <li><a href="#" class="text">Veep T05EP02</a></li>
            <li><a href="#" class="text">Veep T05EP03</a></li>
            <li><a href="#" class="text">Veep T05EP04</a></li>
            <li><a href="#" class="text">Veep T05EP05</a></li>
            <li><a href="#" class="text">Veep T05EP06</a></li>
            <li><a href="#" class="text">Veep T05EP07</a></li>
            <li><a href="#" class="text">Veep T05EP08</a></li>
            <li><a href="#" class="text">Veep T05EP09</a></li>
            <li><a href="#" class="text">Veep T05EP10</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
