...
<link href="css/bootstrap(scream-queens).css" rel="stylesheet" type="text/css">
    ...
    <div class="thumbnail"><a href="Scream-Queens.php"><img src="images/scream-queens.jpg" alt="" width="2000" class="cards"/></a>
      ...
      <p class="tag">Antologia de comédia e terror que se inicia em uma faculdade dos Estados Unidos, onde uma série de assassinatos começa a acontecer de forma misteriosa.</p>
        ...
        <h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Scream Queens T01EP01</a></li>
            <li><a href="#" class="text">Scream Queens T01EP02</a></li>
            <li><a href="#" class="text">Scream Queens T01EP03</a></li>
            <li><a href="#" class="text">Scream Queens T01EP04</a></li>
            <li><a href="#" class="text">Scream Queens T01EP05</a></li>
            <li><a href="#" class="text">Scream Queens T01EP06</a></li>
            <li><a href="#" class="text">Scream Queens T01EP07</a></li>
            <li><a href="#" class="text">Scream Queens T01EP08</a></li>
            <li><a href="#" class="text">Scream Queens T01EP09</a></li>
            <li><a href="#" class="text">Scream Queens T01EP10</a></li>
            <li><a href="#" class="text">Scream Queens T01EP11</a></li>
            <li><a href="#" class="text">Scream Queens T01EP12</a></li>
            <li><a href="#" class="text">Scream Queens T01EP13</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
