...
<title>American Horror Story T06EP08 LEGENDADO</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<video controls autoplay class="cards">
        <source src="http://transforrede.com/vd/dd/RC/RCServer11/ondemand/AMRCHORS06EP08.mp4"></source></video>
        <h4>American Horror Story T06EP08 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
