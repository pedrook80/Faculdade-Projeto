...
<link href="css/bootstrap(american) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>American Horror Story T06EP09 LEGENDADO</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="options">
        <ul id="options">
          <li><a href="https://ok.ru/videoembed/191468604039?rel=0&autoplay=1" target="video1.php"> OPÇÃO 1</a></li>
      </ul>
    <ul id="options1"><li><a href="http://transforrede.com/vd/dd/RC/RCServer11/ondemand/AMRCHORS06EP09.mp4?rel=0&autoplay=1" target="video1.php"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	<iframe name="video1" id="video1" class="cards" width="500px" src="" frameborder="1" allowfullscreen></iframe>
        <h4>American Horror Story T06EP09 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
