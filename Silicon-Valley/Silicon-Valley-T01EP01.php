...
<link href="css/silicon-valley-eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Silicon Valley T01EP01</title>
<script>
...
<source src="http://oo1.hapixel.online/RedeCanais/RCServer09/ondemand/SLCNVLEYT01EP01.mp4" type="video/mp4">
<track label="Português" kind="subtitles" srclang="pt" src="G:\A Site\Legendas\silicon-valley-T01\Silicon.Valley.S01E01.720p.HDTV.x264-KILLERS.src" default>
</video>
        <h4>Silicon Valley T01EP01</h4>
        </div></div></div>
        <!-- Footer Section -->
  <footer id="contact">
  ...
  <!-- Copyrights Section -->
	<div class="copyright">&copy;2019- <strong style="color:#12E19D">VIA SÉRIE </strong></div></div>
  </div>
</body>
</html>
