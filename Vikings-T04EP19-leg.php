...
<title>Vikings T04EP19 LEGENDADO</title>
<script>
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGSS04EP18.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	...
       	<video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		...
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=c4553dfada1cf37b&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1488301425&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=2E5BFAEFFA0324B01065D4ACDBA1DC7E05887A16.F31696D1FAC5C3ACAC4155D7FA3E2B546742B54&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGSS04EP19.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T04EP19 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
