...
<link href="css/bootstrap(chicago-med).css" rel="stylesheet" type="text/css">
</head>
<body>	
<!-- Main Container -->
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Chicago-Med.php"><img src="images/chicago-med.jpg" alt="" width="2000" class="cards"/></a>
      <h4>CHICAGO MED</h4>
      <p class="tag">Acompanhe o caos do dia-a-dia do hospital mais explosivo da cidade de Chicago e da equipe de médicos corajosos que o mantém unido. A série aborda casos únicos inspirados por acontecimentos reais, enquanto desvela as intensas relações que sucedem no ritmo pulsante da sala de emergência.</p>
      <p class="text_column2">Criado por: Dick Wolf, Matt Olmstead, Andrew Dettmann (2015)</p>
      <p class="text_column2">Gênero: Drama, Médico</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Nick Gehlfuss, Yaya DaCosta, Torrey DeVitto, mais...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Chicago Med T01EP01</a></li>
            <li><a href="#" class="text">Chicago Med T01EP02</a></li>
            <li><a href="#" class="text">Chicago Med T01EP03</a></li>
            <li><a href="#" class="text">Chicago Med T01EP04</a></li>
            <li><a href="#" class="text">Chicago Med T01EP05</a></li>
            <li><a href="#" class="text">Chicago Med T01EP06</a></li>
            <li><a href="#" class="text">Chicago Med T01EP07</a></li>
            <li><a href="#" class="text">Chicago Med T01EP08</a></li>
            <li><a href="#" class="text">Chicago Med T01EP09</a></li>
            <li><a href="#" class="text">Chicago Med T01EP10</a></li>
            <li><a href="#" class="text">Chicago Med T01EP11</a></li>
            <li><a href="#" class="text">Chicago Med T01EP12</a></li>
            <li><a href="#" class="text">Chicago Med T01EP13</a></li>
            <li><a href="#" class="text">Chicago Med T01EP14</a></li>
            <li><a href="#" class="text">Chicago Med T01EP15</a></li>
            <li><a href="#" class="text">Chicago Med T01EP16</a></li>
            <li><a href="#" class="text">Chicago Med T01EP17</a></li>
            <li><a href="#" class="text">Chicago Med T01EP18</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
