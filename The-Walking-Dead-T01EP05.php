...
<title>The Walking Dead T01EP05</title>
<script>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
        ...
        <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      	<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=847fc06e0b3ff39a&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1486300834&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=AAF1E8866B707483CAEA623AD9658B447E1FDB62.8EAAF0E517122F6603F6BF6B64C9AE11642499BC&key=ck2"/>
      	<source type="video/mp4" src="#" data-quality="hd"/>
		</video>
        <h4>The Walking Dead T01EP05</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
