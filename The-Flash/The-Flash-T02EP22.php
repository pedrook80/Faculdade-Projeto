...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<iframe src="https://drive.google.com/file/d/0B5wxsQ63PwOPUkdxVTRxWTJTOWc/preview?rel=0&autoplay=1" width="500" allowfullscreen class="cards"></iframe>
        <h4>The Flash T02EP22</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
