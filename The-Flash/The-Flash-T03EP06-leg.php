...
<title>The Flash T03EP06 LEGENDADO</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<iframe src="https://ok.ru/videoembed/194572847751?rel=0&autoplay=1" width="500" allowfullscreen class="cards" frameborder="0"></iframe>
        <h4>The Flash T03EP06 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
