...
<title>2 Broke Girls T03EP14</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video autoplay controls  width="500" class="cards" src="http://cdnfe3.azureedge.net/RCServer09/ondemand/2BRKGLT03EP14.mp4" type="video/mp4">
</source>
</video>
        <h4>2 Broke Girls T03EP14</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
