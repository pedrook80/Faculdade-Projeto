...
<link href="css/bootstrap(gotham) eps-teste.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Gotham T03EP01</title>
<script>
...
<div class="container"> 
  ...
  <div class="options">
        <ul id="options">
       <script> var $divLogin = $("#options");
$divoptions.click(function(){
if ($divLogin.hasClass(".hover"))
    $divLogin.addClass(".visited").removeClass(".hover");
else
    $divLogin.addClass(".hover").removeClass(".visited");
});
</script>
        <li><a href="https://ok.ru/videoembed/89223400071?rel=0&autoplay=1" target="video1.php">OPÇÃO 1</a></li>
        <li><a href="" target="video1.php">OPÇÃO 2</a></li></ul></div> 
  		<div class="thumbnail">
        <iframe name="video1" id="video1" class="cards" width="500px" src="" frameborder="1"></iframe>
