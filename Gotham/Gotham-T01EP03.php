...
<link href="css/bootstrap(colony) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Gotham T01EP03</title></head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<video class="cards" controls autoplay>
        <source src="https://ffpyia.dm2302.livefilestore.com/y3mpGP0P5e9pwngdbh4bzG0mlO2WaSE_YgELumg1i4SWYE_4qzpJihyyO5nywjVHjEp52kqZt_1W_jwQ_5OeVpGykNyeRrAnrSk5InmZfpCLJjY7uLJ73ESQXNYVw_BcNTSuaPQDjyEHSPRktuFHzRrk_QeZ-aEK73zxGrJqCxizvk/GH%2001-03.mp4?psid=1?"></source></video>
        <h4>Gotham T01EP03</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
