...
<title>Colony</title>
<link href="css/bootstrap(colony).css" rel="stylesheet" type="text/css">
 ...
 <div class="container">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Colony.php"><img src="images/colony.jpg" alt="" width="2000" class="cards"/></a>
      <h4>COLONY</h4>
      <p class="tag">Para proteger sua família, um ex-agente do FBI aceita a chantagem de colaborar com o governo para derrubar um movimento de resistência crescente na Los Angeles de um futuro próximo </p>
      <p class="text_column2">Criado por: Ryan Condal, Carlton Cuse (2016)</p>
      <p class="text_column2">Gênero: Drama, Ficção Científica, Suspense</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Josh Holloway, Sarah Wayne Callies, Peter Jacobson, mais...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="Colony-T01EP01.php" class="text">Colony T01EP01 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="Colony-T01EP02.php" class="text">Colony T01EP02 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="Colony-T01EP03.php" class="text">Colony T01EP03 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="Colony-T01EP04.php" class="text">Colony T01EP04 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="Colony-T01EP05.php" class="text">Colony T01EP05</a></li>
            <li><a href="#" class="text">Colony T01EP06 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="Colony-T01EP07.php" class="text">Colony T01EP07 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="Colony-T01EP08.php" class="text">Colony T01EP08</a></li>
            <li><a href="Colony-T01EP09.php" class="text">Colony T01EP09</a></li>
            <li><a href="Colony-T01EP10.php" class="text">Colony T01EP10</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
