...
<div class="container"> 
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer07/ondemand/ARROWT02EP20.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
     ...
     <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      <source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=36e57262f1453acb&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1485809673&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=970BB6808B0883223455E6852A9FAB4F9C8D7AD7.F79EDF6DC4416759C020156ECA18063B35283FD&key=ck2"/>
      <source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer09/ondemand/ARROWT02EP20.mp4" data-quality="hd"/>
		</video>
        <h4>Arrow T02EP20</h4>
	</div></div>
        <!-- Footer Section -->
