...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer07/ondemand/ARROWT02EP14.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
     ...
     <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      ...
      <source type="video/mp4" src="http://cdn.ec.cx/vd/dd/RC/RCServer09/ondemand/ARROWT02EP14.mp4" data-quality="hd"/>
		</video>
        <h4>Arrow T02EP14</h4>
	</div></div>
        <!-- Footer Section -->
