...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer07/ondemand/ARROWT02EP05.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
     ...
     <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      <source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=21d522aa8ce53c9e&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1485804963&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=2E52F4DCBF9EC4F7F6AF4CDE64CF8D7110F5E0D5.C355563703E17CB75ED5EDD094151BE70A8AE45&key=ck2"/>
      <source type="video/mp4" src="http://cdn.ec.cx/vd/dd/RC/RCServer09/ondemand/ARROWT02EP05.mp4" data-quality="hd"/>
		</video>
        <h4>Arrow T02EP05</h4>
	</div></div>
        <!-- Footer Section -->
