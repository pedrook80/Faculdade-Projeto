...
<link href="css/bootstrap(quantico) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Quantico T02EP09 LEGENDADO</title>
<script>
 ...
 <div class="container">
  ...
  <div class="gallery">
 		<div class="thumbnail">
  		<!--<div class="options">
        <ul id="options">
          <li><a href="https://1fhjlol.oloadcdn.net/dl/l/xOg8ZHUjSBx7QdZ1/L10fmTom0zk/Série sOnlineHD.org+-+G4briel720+-+Qu4nt1c0.S02E08.720p.Leg.mp4?mime=true" target="video1"> OPÇÃO 1</a></li>
      </ul>
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer11/ondemand/QNTCS02EP08.mp4" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	<iframe name="video1" id="video1" class="cards" width="500px" src="" frameborder="1" allowfullscreen></iframe>-->
       	<video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      	<source type="video/mp4" src="https://r3---sn-gpv7eney.googlevideo.com/videoplayback?requiressl=yes&id=2d64a90323b9373f&itag=18&source=blogger&app=blogger&ip=177.205.92.236&ipbits=0&expire=1488299712&sparams=expire,id,ip,ipbits,itag,mm,mn,ms,mv,nh,pl,requiressl,sc,source&signature=0F876AE22032DC46A0025A0AA7BD3D2AAE0B6C7D.519E6D85737F1EF81725C900D7BF8C8B034424D1&key=cms1&cms_redirect=yes&mm=30&mn=sn-gpv7eney&ms=nxu&mt=1486152204&mv=m&nh=IgpwcjAzLnJpbzAxKgkxMjcuMC4wLjE&pl=21&sc=yes"/>
      	<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/QNTCS02EP09.mp4" data-quality="hd"/></video>     
        <h4>Quantico T02EP09 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
    <p class="hero_header">ALGUM PROBLEMA!!!??</p>
    <div class="button"><a style="text-decoration:none; color:#FFFFFF" href="contato.php">AVISE-NOS</a></div>
  </footer>
  <!-- Copyrights Section -->
