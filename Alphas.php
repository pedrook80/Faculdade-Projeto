...
<link href="css/bootstrap(alphas).css" rel="stylesheet" type="text/css">
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"> <a href="Alphas.php"><img src="images/Alphas.jpg" alt="" width="2000" class="cards"/></a>
      <h4>ALPHAS</h4>
      <p class="tag">Após a morte de uma testemunha em um tribunal, o Dr. Lee Rosen (David Strathairn) lidera um time de "Alfas" (seres humanos avançados) que tem habilidadesespeciais que fazem deles um grupo consideravelmente poderoso. Enquanto Rosen os ensinaa controlarem suas respectivas habilidades, eles começam a entender que há forças poderosas por trás do assassinato no tribunal, inclusive um traidor entre eles.</p>
      <p class="text_column2">Criado por: Gail Berman, Lloyd Braun (2011)</p>
      <p class="text_column2">Gênero: Drama, Fantasia, Ficção científica.</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: David Strathairn, Malik Yoba, Warren Christie</p>
      <p class="text_column2">Status: Cancelada</p>
      <p class="text_column2">Duração: 42 minuto</p>
		<div class="ver"></div>
		<h3 class="thumb22"><span style="color:red">EM BREVE</span></h3>
        <!--<h3 class="thumb22"><span>1ª Temporada</span></h3>
			<div id="epsetemps">
        		<ul class="temps" id="temp1">
           	<li><a href="#" class="text">Alphas T01EP02</a></li>
            <li><a href="#" class="text">Alphas T01EP03</a></li>
            <li><a href="#" class="text">Alphas T01EP04</a></li>
            <li><a href="#" class="text">Alphas T01EP05</a></li>
            <li><a href="#" class="text">Alphas T01EP06</a></li>
            <li><a href="#" class="text">Alphas T01EP07</a></li>
            <li><a href="#" class="text">Alphas T01EP08</a></li>
            <li><a href="#" class="text">Alphas T02EP09</a></li>
            <li><a href="#" class="text">Alphas T02EP10</a></li>
            <li><a href="#" class="text">Alphas T02EP11</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
		 	<li><a href="#" class="text">Alphas T02EP01</a></li>
            <li><a href="#" class="text">Alphas T02EP02</a></li>
            <li><a href="#" class="text">Alphas T02EP03</a></li>
            <li><a href="#" class="text">Alphas T02EP04</a></li>
            <li><a href="#" class="text">Alphas T02EP05</a></li>
            <li><a href="#" class="text">Alphas T02EP06</a></li>
            <li><a href="#" class="text">Alphas T02EP07</a></li>
            <li><a href="#" class="text">Alphas T02EP08</a></li>
            <li><a href="#" class="text">Alphas T02EP09</a></li>
            <li><a href="#" class="text">Alphas T02EP10</a></li>
            <li><a href="#" class="text">Alphas T02EP11</a></li>
            <li><a href="#" class="text">Alphas T02EP12</a></li>
            <li><a href="#" class="text">Alphas T02EP13</a></li>
         	</ul></div>-->
		</div>
  </div>
  <!-- Footer Section -->
