 ...
 <div class="container">
  ...
  <div class="gallery">
    ...
    <div class="thumbnail"> <a href="The-Flash.php"><img src="images/the flash.jpg" alt="" width="2000" class="cards"/></a>
      ...
      <p class="tag">Barry Allen (Grant Gustin) era um funcionário da Polícia Científica que, ao sofrer um acidente, foi banhado por produtos químicos em seu laboratório e, em seguida, atingido por um<a href="The-Flash.php">Mais ...</a></p>
    </div>
  ...
  <div class="gallery">
    ...
    <div class="thumbnail"> <a href="Game-of-Thrones.php"><img src="images/Game-of-Thrones.jpg" alt="" width="2000" class="cards"/></a>
      ...
      <p class="tag">Há muito tempo, em um tempo esquecido, uma força destruiu o equilíbrio das estações. Em uma terra onde os verões podem durar vários anos e o inverno toda uma vida<a href="Game-of-Thrones.php">Mais ...</a></p>
    </div>
    <div class="thumbnail"> <a href="Gotham.php"><img src="images/gotham.jpg" alt="" width="2000" class="cards"/></a>
      ...
      <p class="tag">Antes de Batman, a cidade de Gotham já existia. James Gordon (Ben McKenzie) é um detetive iniciante polícia. Corajoso, sincero e ansioso para mostrar serviço, o recém<a href="Gotham.php">Mais ...</a></p>
    </div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
