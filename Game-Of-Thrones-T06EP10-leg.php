...
<link href="css/bootstrap(game-of) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Game Of Thrones T06EP10</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0B_I23Abnn9WIVV80UEt3TmM1NHM/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>Game Of Thrones T06EP10 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
