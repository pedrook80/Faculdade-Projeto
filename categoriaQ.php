...
<div class="corp"><div align="center" class="center"><img src="images/logo2.png"/></div>
 <div class="container">
    ...
    <nav id="menu" class="container">
      <ul id="menu-top-menu" class="sf-menu">
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="categoriaQ" selected="selected">Categoria Q</option>
  ...
  <div class="gallery">
    <div class="thumbnail"> <a href="Quantico.php"><img src="images/quantico.jpg" alt="Quantico" width="2000" class="cards"/></a>
      <h4><a href="Quantico.php">QUANTICO</a></h4>
      <p class="tag">Um grupo diverso de brilhantes e controlados recrutas chega à base do FBI em Quantico para o treinamento. Eles são considerados alguns dos melhores agentes, mas<a href="Quantico">Mais ...</a></p>
    </div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
