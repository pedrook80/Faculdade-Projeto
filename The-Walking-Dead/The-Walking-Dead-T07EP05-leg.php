...
<title>The Walking Dead T07EP05 LEGENDADO</title>
</head>
<body>
<!-- Main Container -->
<div class="container"> 
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
        <iframe src="http://cdn.ec.cx/vd/dd/RC/RCServer11/ondemand/TWDS07EP05.mp4?rel=0&autoplay=1" width="500" frameborder="0" class="cards" allowfullscreen></iframe>
        <h4>The Walking Dead T07EP05 <strong style="color: red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
