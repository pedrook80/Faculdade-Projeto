...
<title>The Walking Dead T07EP01</title>
</head>
<body>
<!-- Main Container -->
<div class="container"> 
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
        <iframe src="https://www.youtube.com/embed/GCSZJk2pdpI?rel=0&autoplay=1" width="500" frameborder="0" class="cards" allowfullscreen></iframe>
        <h4>The Walking Dead T07EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
