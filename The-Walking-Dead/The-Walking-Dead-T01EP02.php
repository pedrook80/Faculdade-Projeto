...
<title>The Walking Dead T01EP02</title>
<script>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
        ...
        <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      	<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=50137ed65043e664&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1486300210&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=25E2832415F057D9C020D12F5E91521DB0A4866A.3234E7D06F3C1286CE571604EDA52B969B5EDB83&key=ck2"/>
      	<source type="video/mp4" src="#" data-quality="hd"/>
		</video>
        <h4>The Walking Dead T01EP02</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
