...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0Bx53Ki2dV7ziQWNETFExZE5ndEk/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>Blindspot T01EP13 <strong style="color">Lengendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
