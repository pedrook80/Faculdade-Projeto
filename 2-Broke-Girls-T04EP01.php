...
<title>2 Broke Girls T04EP01</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video autoplay controls  width="500" class="cards" src="http://cdnfe3.azureedge.net/RCServer09/ondemand/2BRKGLT04EP01.mp4" type="video/mp4"></video>
        <h4>2 Broke Girls T04EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
