...
<title>Bitten</title>
<link href="css/bootstrap(bitten).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Bitten.php"><img src="images/Bitten.jpg" alt="" width="2000" class="cards"/></a>
      <h4>BITTEN</h4>
      <p class="tag">As aventuras de Elena Michaels (Laura Vandervoort), uma bela loira de 28 anos de idade que é a única lobisomem do sexo feminino em todo o mundo. Órfã, ela imaginava que tinha encontrado seu “feliz para sempre” ao lado de Clayton (Greyston Holt), até que, com uma simples mordida, sua vida mudou para sempre.</p>
      <p class="text_column2">Criado por: Daegan Fryklind (2014)</p>
      <p class="text_column2">Gênero: Drama, Fantasia, Suspense</p>
      <p class="text_column2">País: Canadá</p>
      <p class="text_column2">Atores: Laura Vandervoort, Greyston Holt, Greg Bryk, mais ...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Bitten T01EP01</a></li>
            <li><a href="#" class="text">Bitten T01EP02</a></li>
            <li><a href="#" class="text">Bitten T01EP03</a></li>
            <li><a href="#" class="text">Bitten T01EP04</a></li>
            <li><a href="#" class="text">Bitten T01EP05</a></li>
            <li><a href="#" class="text">Bitten T01EP06</a></li>
            <li><a href="#" class="text">Bitten T01EP07</a></li>
            <li><a href="#" class="text">Bitten T01EP08</a></li>
            <li><a href="#" class="text">Bitten T01EP09</a></li>
            <li><a href="#" class="text">Bitten T01EP10</a></li>
            <li><a href="#" class="text">Bitten T01EP11</a></li>
            <li><a href="#" class="text">Bitten T01EP12</a></li>
            <li><a href="#" class="text">Bitten T01EP13</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="#" class="text">Bitten T02EP01</a></li>
            <li><a href="#" class="text">Bitten T02EP02</a></li>
            <li><a href="#" class="text">Bitten T02EP03</a></li>
            <li><a href="#" class="text">Bitten T02EP04</a></li>
            <li><a href="#" class="text">Bitten T02EP05</a></li>
            <li><a href="#" class="text">Bitten T02EP06</a></li>
            <li><a href="#" class="text">Bitten T02EP07</a></li>
            <li><a href="#" class="text">Bitten T02EP08</a></li>
            <li><a href="#" class="text">Bitten T02EP09</a></li>
            <li><a href="#" class="text">Bitten T02EP10</a></li>
                </ul></div>
			<h3 class="heading"><span>3ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="#" class="text">Bitten T03EP01</a></li>
            <li><a href="#" class="text">Bitten T03EP02</a></li>
            <li><a href="#" class="text">Bitten T03EP03</a></li>
            <li><a href="#" class="text">Bitten T03EP04</a></li>
            <li><a href="#" class="text">Bitten T03EP05</a></li>
            <li><a href="#" class="text">Bitten T03EP06</a></li>
            <li><a href="#" class="text">Bitten T03EP07</a></li>
            <li><a href="#" class="text">Bitten T03EP08</a></li>
            <li><a href="#" class="text">Bitten T03EP09</a></li>
            <li><a href="#" class="text">Bitten T03EP10</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
