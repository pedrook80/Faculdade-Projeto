...
<link href="css/bootstrap(constantine).css" rel="stylesheet" type="text/css">
</head>
<body>	
<!-- Main Container -->
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Constantine.php"><img src="images/constantine.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="Constantine.php">CONSTANTINE</a></h4>
      <p class="tag">John Constantine (Matt Ryan) é um detetive com habilidades sobrenaturais. Perseguido por mistérios e segredos de seu próprio passado, a vida de John é mudada quando suas habilidades são descobertas pelas forças do céu, ou seja, pelo autoritário anjo Manny (Harold Perrineau). Ele irá ajudar o detetive a se tornar um grande e feroz defensor das forças do bem contra o mal. Baseada na série de quadrinhos da DC Comics “Hellblazer”.</p>
      <p class="text_column2">Criado por: David S. Goyer, Daniel Cerone (2014)</p>
      <p class="text_column2">Gênero: Drama, Fantasia</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Matt Ryan, Harold Perrineau, Charles Halford, mais ...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Constantine T01EP01</a></li>
            <li><a href="#" class="text">Constantine T01EP02</a></li>
            <li><a href="#" class="text">Constantine T01EP03</a></li>
            <li><a href="#" class="text">Constantine T01EP04</a></li>
            <li><a href="#" class="text">Constantine T01EP05</a></li>
            <li><a href="#" class="text">Constantine T01EP06</a></li>
            <li><a href="#" class="text">Constantine T01EP07</a></li>
            <li><a href="#" class="text">Constantine T01EP08</a></li>
            <li><a href="#" class="text">Constantine T01EP09</a></li>
            <li><a href="#" class="text">Constantine T01EP10</a></li>
            <li><a href="#" class="text">Constantine T01EP11</a></li>
            <li><a href="#" class="text">Constantine T01EP12</a></li>
            <li><a href="#" class="text">Constantine T01EP13</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
