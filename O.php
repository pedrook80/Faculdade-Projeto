    ...
    <h4>GOTHAM</h4>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="heading"><span>2ª Temporada</span></h3>
			...
			<h3 class="heading"><span>3ª Temporada <strong style="color:red">EM BREVE</strong></span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            ...
            <li><a href="Gotham-T03EP06-leg.php" class="text">Gotham T03EP06 / LEGENDADO</a></li>
            <li><a href="Gotham-T03EP07-leg.php" class="text">Gotham T03EP07 / LEGENDADO<img src="images/new.png" alt="Novo episodio '3ª Temporada episodio 7 Legendado" width="29px"/></a></li>
            <!--<li><a href="#" class="text">Gotham T03EP08</a></li>
            <li><a href="#" class="text">Gotham T03EP09</a></li>
            <li><a href="#" class="text">Gotham T03EP10</a></li>
            <li><a href="#" class="text">Gotham T03EP11</a></li>
            <li><a href="#" class="text">Gotham T03EP12</a></li>
            <li><a href="#" class="text">Gotham T03EP13</a></li>
            <li><a href="#" class="text">Gotham T03EP14</a></li>
