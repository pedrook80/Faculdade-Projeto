...
<div class="corp"><div align="center" class="center"><img src="images/logo2.png"/></div>
 <div class="container">
    ...
    <nav id="menu" class="container">
      <ul id="menu-top-menu" class="sf-menu">
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="categoriaO" selected="selected">Categoria O</option>
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Once-Upon-A-Time.php"><img src="images/once-upon-a-time.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="Once-Upon-a-Time.php">ONCE UPON A TIME</a></h4>
      <p class="tag">Na cidade fictícia de Storybrooke, no Maine, Regina (Lana Parrilla) é uma rainha má que rouba memórias graças à maldição obtida por meio de Rumplestiltskin (Robert Carlyle)feitiço.<a href="Once-Upon-a-Time">Mais ...</a></p>
    </div>
    <div class="thumbnail" id="thumbnail10"><a href=""><img src="images/onegocio.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="">O NEGÓCIO</a></h4>
      <p class="tag">Karin (Rafaela Mandelli), Luna (Juliana Schalch) e Magali (Michelle Batista) são profissionais naquilo que fazem. Sem perspectiva de melhorar a profissão, elas<a href="#">Mais ...</a></p>  
    </div>
    <div class="thumbnail" id="thumbnail10"><a href=""><img src="images/orange-is-the-new-black.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="">ORANGE IS THE NEW BLACK</a></h4>
      <p class="tag">Piper Chapman é uma mulher na casa dos 30 anos que é sentenciada a 15 meses de prisão por um crime que cometeu há quase dez anos. Ela transportou dinheiro<a href="#">Mais ...</a></p>
    </div>
    <div class="thumbnail" id="thumbnail10"><a href=""><img src="images/orphan black.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="">ORPHAN BLACK</a> </h4>
      <p class="tag">Depois de presenciar o suicídio de uma mulher (que é exatamente como ela) em uma estação de trem, Sarah Manning (Tatiana Maslany) faz o que qualquer um faria<a href="#">Mais ...</a></p> 
    </div>
    <div class="thumbnail" id="thumbnail10"><a href=""><img src="images/outcast.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="">OUTCAST</a></h4>
      <p class="tag">Kyle Barnes é um homem atormentado por uma possessão desde a infância. Agora, ele embarca em uma jornada espiritual determinado a descobrir a verdade<a href="#">Mais ...</a></p>
    </div>
	</div>
  <!-- Footer Section -->
  <footer id="contact">
