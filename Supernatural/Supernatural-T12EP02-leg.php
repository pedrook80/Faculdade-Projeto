...
<title>Supernatural T12EP02 LEGENDADO</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
  		  <iframe width="560" src="//ok.ru/videoembed/89809291911?rel=0&autoplay=1" frameborder="0" allowfullscreen class="cards"></iframe>
  		  <h4>Supernatural T12EP02<strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
