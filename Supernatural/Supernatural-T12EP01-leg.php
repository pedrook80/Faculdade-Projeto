...
<title>Supernatural T12EP01 LEGENDADO</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="//ok.ru/videoembed/89586469511?rel=0&autoplay=1" width="560" frameborder="0" class="cards" allowfullscreen></iframe>
        <h4>Supernatural T12EP01 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
