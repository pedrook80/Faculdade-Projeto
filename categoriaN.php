...
<div class="corp"><div align="center" class="center"><img src="images/logo2.png"/></div>
 <div class="container">
    ...
    <nav id="menu" class="container">
      <ul id="menu-top-menu" class="sf-menu">
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="categoriaN" selected="selected">Categoria N</option>
  ...
  <div class="gallery">
    <div class="thumbnail"><a href=""><img src="images/narcos.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="">NARCOS</a></h4>
      <p class="tag">A trama gira em torno do traficante Pablo Escobar (Wagner Moura), retratando a história de ascensão dele de um criminoso comum para um dos homens mais perigosos<a href="#">Mais ...</a></p>
    </div>
    <div class="thumbnail"><a href=""><img src="images/nikitaa.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="">NIKITA</a></h4>
      <p class="tag">Após a morte do seu noivo, a assassina Nikita (Maggie Q) abandona a Division, uma agência secreta dos Estados Unidos que a recrutou ainda jovem. Ela decide se vingar e<a href="#">Mais ...</a></p>
    </div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
