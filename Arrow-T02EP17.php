...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer07/ondemand/ARROWT02EP17.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
     ...
     <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      <source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=1feba48ffb39e9fa&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1485809058&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=8AF0CB2931BE2F04374CC71B531D85A3A7F3B42B.A91FBBD7F1FB3A88B8867A74C670CDCAF88AD40E&key=ck2"/>
      <source type="video/mp4" src="http://cdn.ec.cx/vd/dd/RC/RCServer09/ondemand/ARROWT02EP17.mp4" data-quality="hd"/>
		</video>
        <h4>Arrow T02EP17</h4>
	</div></div>
        <!-- Footer Section -->
