...
<title>Black Sails T03EP08</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail"> 
           <iframe src="https://docs.google.com/file/d/0B1muCYhoaBobNndQTmtwcHV0R1k/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>Black Sails T03EP08 <strong style=" color: red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
