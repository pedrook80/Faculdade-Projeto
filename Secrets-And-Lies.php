...
<link href="css/bootstrap(secrets).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
    <nav id="menu" class="container">
      <ul id="menu-top-menu" class="sf-menu">
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
        	<option value="#" selected="selected">Menu - Lista de Séries A - Z...</option>
  ...
  <div class="gallery">
    <div class="thumbnail"><a><img class="cards" src="images/secrets-and-lies.jpeg" alt="Secrets And Lies" width="2000"/></a>
    <h4>SECRETS AND LIES</h4>
		<p class="tag">Ben (Ryan Phillippe) é um pai de família que encontra o corpo de um garoto, e torna-se o principal suspeito de cometer o crime. Para salvar seu casamento, seus filhos, a reputação e a sanidade, ele  não tem outra opção a não ser encontrar o verdadeiro culpado, correndo contra a Detetive Andrea Cornell (Juliette Lewis), que está investigando o caso com foco em Ben.</p>
      <p class="text_column2">Criado por: Barbie Kligman (2015)</p>
      <p class="text_column2">Gênero: Drama, Policial</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Juliette Lewis, Michael Ealy, Jordana Brewster mais ...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
			<div id="epsetemps">
			<ul id="lista_eps1">
     		<li><a href="Secrets-And-Lies-T01EP01-leg.php" class="text">Secrets And Lies T01EP01 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T01EP02-leg.php" class="text">Secrets And Lies T01EP02 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T01EP03-leg.php" class="text">Secrets And Lies T01EP03 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T01EP04-leg.php" class="text">Secrets And Lies T01EP04 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T01EP05-leg.php" class="text">Secrets And Lies T01EP05 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T01EP06-leg.php" class="text">Secrets And Lies T01EP06 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T01EP07-leg.php" class="text">Secrets And Lies T01EP07 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T01EP08-leg.php" class="text">Secrets And Lies T01EP08 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T01EP09-leg.php" class="text">Secrets And Lies T01EP09 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T01EP10-leg.php" class="text">Secrets And Lies T01EP10 / <strong style="color:green">LEGENDADO</strong></a></li>
			</ul></div>
            <h3 class="thumb22"><span>2ª Temporada</span></h3>
			<div id="temp2">
          	<ul id="lista_eps2">
           	<li><a href="Secrets-And-Lies-T02EP01.php" class="text">Secrets And Lies T02EP01 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T02EP02.php" class="text">Secrets And Lies T02EP02 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T02EP03.php" class="text">Secrets And Lies T02EP03 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T02EP04.php" class="text">Secrets And Lies T02EP04 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T02EP05.php" class="text">Secrets And Lies T02EP05 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T02EP06.php" class="text">Secrets And Lies T02EP06 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T02EP07.php" class="text">Secrets And Lies T02EP07 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T02EP08.php" class="text">Secrets And Lies T02EP08 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T02EP09.php" class="text">Secrets And Lies T02EP09 / <strong style="color:green">LEGENDADO</strong></a></li>
            <li><a href="Secrets-And-Lies-T02EP10.php" class="text">Secrets And Lies T02EP10 / <strong style="color:green">LEGENDADO</strong> <img src="images/new.png" width="29px" alt="Novo episodio '2ª Temporada episodio 10"/></a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
