...
<link href="css/bootstrap(vikings) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Vikings T01EP07</title>
<script>
...
<div class="container"> 
  ...
  <div class="gallery">
  	<!--<div class="options">
        <ul id="options">
              <li><a href="Indisponivel.php" target="video1"> OPÇÃO 1</a></li>
      </ul>
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP07.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
        ...
        <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=a48ce5c5723a08c1&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1487610102&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=A96C20214C47DCE96FC0FDF9467D0EF143459633.3028B8FF797E1202EC1BB6FBD41386C3564257BA&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP07.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T01EP07</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
  ...
  <!-- Copyrights Section -->
  <div class="copyright">&copy;2016 -<a style="text-decoration:none" href="index.php"><strong style="color:#12E19D">VIA SÉRIE</strong></a></div>
  </div>
</body>
</html>