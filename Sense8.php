...
<title>Sense8</title>
<link href="css/bootstrap(sense8).css" rel="stylesheet" type="text/css">
</head>
<body>	
<!-- Main Container -->
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Sense8.php"><img src="images/Sense8.jpg" alt="" width="2000" class="cards"/></a>
      <h4>SENSE8</h4>
      <p class="tag">Grupos de pessoas ao redor do mundo estão ligadas mentalmente, e precisam achar uma maneira de sobreviver sendo caçados por aqueles que os veem como uma ameaça para a ordem mundial.</p>
      	<p>Criado por: Andy Wachowski, Lana Wachowski, J. Michael Straczynski (2015)</p>
		<p>Gênero: Drama, Fantasia, Ficção Científica</p>
		<p>País: EUA</p>
		<p>Atores: Aml Ameen, Doona Bae, Jamie Clayton, mais ...</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Sense8 T01EP01</a></li>
            <li><a href="#" class="text">Sense8 T01EP02</a></li>
            <li><a href="#" class="text">Sense8 T01EP03</a></li>
            <li><a href="#" class="text">Sense8 T01EP04</a></li>
            <li><a href="#" class="text">Sense8 T01EP05</a></li>
            <li><a href="#" class="text">Sense8 T01EP06</a></li>
            <li><a href="#" class="text">Sense8 T01EP07</a></li>
            <li><a href="#" class="text">Sense8 T01EP08</a></li>
            <li><a href="#" class="text">Sense8 T01EP09</a></li>
            <li><a href="#" class="text">Sense8 T01EP10</a></li>
            <li><a href="#" class="text">Sense8 T01EP11</a></li>
            <li><a href="#" class="text">Sense8 T01EP12</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
