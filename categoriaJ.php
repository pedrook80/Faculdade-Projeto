...
<div class="corp"><div align="center" class="center"><img src="images/logo2.png"/></div>
 <div class="container">
    ...
    <nav id="menu" class="container">
      ...
      <?php  } ?>
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="categoriaJ" selected="selected">Categoria J</option>
  ...
  <div class="gallery">
    <div class="thumbnail" id="thumbnail10"><a href="#"><img src="images/jessica-jones.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="#">JESSICA JONES</a></h4>
      <p class="tag">Jessica Campbell (Krysten Ritter) é uma estudante do ensino médio, colega de classe de Peter Parker, que após se envolver em um acidente fatal com um comboio que carregava produtos<a href="#">Mais ...</a></p>
    </div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
