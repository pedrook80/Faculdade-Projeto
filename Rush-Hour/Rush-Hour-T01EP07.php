...
<link href="css/bootstrap(rush-hour) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Rush Hour T01EP07</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<iframe src="https://drive.google.com/file/d/0Bx-lVPrOrIxnSkk4aV96N3g5RTg/preview?rel=0&autoplay=1" width="500" class="cards"></iframe>
        <h4>Rush Hour T01EP07</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
