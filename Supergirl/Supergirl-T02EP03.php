...
<div class="container"> 
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://ok.ru/videoembed/191382489735?rel=0&autoplay=1" frameborder="0" width="500" class="cards" allowfullscreen></iframe>
        <h4>Supergirl T02EP03</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
