...
<title>Supergirl T02EP06 LEGENDADO</title>
<script>
...
<div class="container"> 
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://ok.ru/videoembed/194012580487?rel=0&autoplay=1" frameborder="0" width="500" class="cards" allowfullscreen></iframe>
        <h4>Supergirl T02EP06 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
