...
<link href="css/bootstrap(supergirl) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Supergirl T02EP04 LEGENDADO</title>
<script>
...
<div class="container"> 
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://ok.ru/videoembed/187389381255?rel=0&autoplay=1" frameborder="0" width="500" class="cards" allowfullscreen></iframe>
        <h4>Supergirl T02EP04 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
