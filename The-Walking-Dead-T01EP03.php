...
<title>The Walking Dead T01EP03</title>
<script>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
        ...
        <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      	<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=5471a18f51b9a4af&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1486300458&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=34C4C43C985D99EEBF367E7F9D717A5ABA990C11.526B707B23F2C5E6477CD570F0F6F151202A7B7D&key=ck2"/>
      	<source type="video/mp4" src="#" data-quality="hd"/>
		</video>
        <h4>The Walking Dead T01EP03</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
