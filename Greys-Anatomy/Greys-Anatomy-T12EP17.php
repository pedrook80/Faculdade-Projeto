...
<title>Grey's Anatomy T12EP17</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<iframe src="https://docs.google.com/file/d/0BzP3ww6k5pngX0JPTGxZbEtucDg/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen frameborder="0"></iframe>
        <h4>Grey's Anatomy T12EP17</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
