...
<link href="css/bootstrap(greys anatomyl) esps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Grey's Anatomy T12EP03</title>
</head>
<body>
<!-- Main Container -->
<div class="container"> 
  ...
  <div class="gallery">
  		<div class="thumbnail">
<iframe src="https://docs.google.com/file/d/0BzP3ww6k5pngc25oRFNDb3hZN1U/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen frameborder="0"></iframe>
        <h4>Grey's Anatomy T12EP03</h4>
        </div>
        </div>
        <!-- Footer Section -->
  <footer id="contact">
  ...
  <!-- Copyrights Section -->
  <div class="copyright">&copy;2019- <strong style="color:#12E19D">VIA SÉRIE </strong></div>
  </div>
</body>
</html>
