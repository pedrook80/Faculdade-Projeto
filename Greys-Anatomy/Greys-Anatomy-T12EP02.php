...
<title>Grey's Anatomy T12EP02</title>
</head>
<body>
<!-- Main Container -->
<div class="container"> 
  <!-- Header -->
  <header class="header">
    <h4 class="logo"><a href="images/vsicon.png.php">VIA SÉRIE </a></h4>
  </header>
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://docs.google.com/file/d/0BzP3ww6k5pngOGRBNU9Pa0Q0cEk/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen frameborder="0"></iframe>
        <h4>Grey's Anatomy T12EP02</h4>
        </div>
        </div>
        <!-- Footer Section -->
  <footer id="contact">
