...
<title>Grey's Anatomy T12EP06</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video class="cards" autoplay controls width="500">
<source src="http://rc.lella.la/vd/dd/RC/RCServer10/ondemand/GRATT12EP06.mp4" type="video/mp4">
</source>
</video>
        <h4>Grey's Anatomy T12EP06</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
