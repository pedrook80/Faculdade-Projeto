...
<title>Grey's Anatomy T12EP19</title>
</head>
<body>
<!-- Main Container -->
<div class="container"> 
  ...
  <div class="gallery">
		...
		<source src="http://rc.lella.la/vd/dd/RC/RCServer10/ondemand/GRATT12EP19.mp4" type="video/mp4"></source></video>
        <h4>Grey's Anatomy T12EP19</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
