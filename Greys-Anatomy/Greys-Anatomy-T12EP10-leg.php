...
<title>Grey's Anatomy T12EP10 (Legendado)</title>
</head>
<body>
<!-- Main Container -->
...
<source src="http://rc.lella.la/vd/dd/RC/RCServer10/ondemand/GRATS12EP10.mp4" type="video/mp4">
</source>
</video>
        <h4>Grey's Anatomy T12EP10 <strong style=" color: red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
