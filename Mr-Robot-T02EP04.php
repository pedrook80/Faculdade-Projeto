...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
	...
	<source src="https://oqbki3.oloadcdn.net/dl/l/irD-FO2CDYg/EdQFIqAI5QI/Sr.R4qu1r.S02E04.720p.Leg.mp4?mime=true" type="video/mp4">
	</source>
	</video>
        <h4>Mr. Robot T02EP04</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
