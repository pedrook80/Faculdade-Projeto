...
<title>Damien</title>
<link href="css/bootstrap(damien).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Damien.php"><img src="images/damien.jpg" alt="" width="2000" class="cards"/></a>
      <h4>DAMIEN</h4>
      <p class="tag">Baseado no filme A Profecia, de 1976. A série conta a história de Damien Thorn (Bradley James), um jovem perseguido pelo seu passado que precisa enfrentar uma verdade obscura: ele é o anticristo.</p>
      <p class="text_column2">Criado por: Glen Mazzara (2016)</p>
      <p class="text_column2">Gênero: Drama, Policial</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Bradley James , Megalyn Echikunwoke, mais ...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Damien T01EP01</a></li>
            <li><a href="#" class="text">Damien T01EP02</a></li>
            <li><a href="#" class="text">Damien T01EP03</a></li>
            <li><a href="#" class="text">Damien T01EP04</a></li>
            <li><a href="#" class="text">Damien T01EP05</a></li>
            <li><a href="#" class="text">Damien T01EP06</a></li>
            <li><a href="#" class="text">Damien T01EP07</a></li>
            <li><a href="#" class="text">Damien T01EP08</a></li>
            <li><a href="#" class="text">Damien T01EP09</a></li>
            <li><a href="#" class="text">Damien T01EP10</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
