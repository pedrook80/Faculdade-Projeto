...
<title>Quantico T02EP07 LEGENDADO</title>
<script>
...
<div class="container"> 
  ...
  <div class="gallery">
 		<div class="thumbnail">
  		<!--<div class="options">
        <ul id="options">
          <li><a href="https://openload.co/stream/Dd1yMA6Uez8~1484150884~191.223.0.0~WbgOXlxa?mime=true" target="video1"> OPÇÃO 1</a></li>
      </ul>
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer11/ondemand/QNTCS02EP07.mp4" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
      	...
      	<source type="video/mp4" src="https://openload.co/stream/Dd1yMA6Uez8~1484150884~191.223.0.0~WbgOXlxa?mime=true"/>
      	<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/QNTCS02EP07.mp4" data-quality="hd"/></video>      
        <h4>Quantico T02EP07 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
