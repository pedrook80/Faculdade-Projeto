...
<title>Quantico T02EP02 LEGENDADO</title>
<script>
...
<div class="container"> 
    ...
    <nav id="menu" class="container">
      <ul id="menu-top-menu" class="sf-menu">
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
        	<option value="#" selected="selected">Menu - Lista de es A - Z...</option>
  ...
  <div class="gallery">
 		<div class="thumbnail">
  		<!--<div class="options">
        <ul id="options">
          <li><a href="https://1fhjlp8.oloadcdn.net/dl/l/cP-m-YLhhwvEJA9Z/dob8BSGkixY/SeriesOnlineHD.org+-+G4briel720+-+Qu4nt1c0.S02E02.720p.Leg.mp4?mime=true?mime=true" target="video1"> OPÇÃO 1</a></li>
      </ul>
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer11/ondemand/QNTCS02EP02.mp4" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
      ...
      <source type="video/mp4" src="https://1fhjlp8.oloadcdn.net/dl/l/cP-m-YLhhwvEJA9Z/dob8BSGkixY/SeriesOnlineHD.org+-+G4briel720+-+Qu4nt1c0.S02E02.720p.Leg.mp4?mime=true"/>
      <source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/QNTCS02EP02.mp4" data-quality="hd"/></video>    
        <h4>Quantico T02EP02 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
