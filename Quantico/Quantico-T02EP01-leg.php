...
<title>Quantico T02EP01 LEGENDADO</title>
<script>
...
<div class="container"> 
  ...
  <div class="gallery">
 		<div class="thumbnail">
  		<!--<div class="options">
        <ul id="options">
          <li><a href="https://oqfnxl.oloadcdn.net/8a8spKmJVGU/SeriesOnlineHD.org+-+G4briel720+-+Qu4nt1c0.S02E01.720p.Leg.mp4?mime=true" target="video1"> OPÇÃO 1</a></li>
      </ul>
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer11/ondemand/QNTCS02EP01.mp4" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
      ...
      <source type="video/mp4" src="https://oqfnxl.oloadcdn.net/dl/l/liEjgjGAQgC1vKSB/8a8spKmJVGU/SeriesOnlineHD.org+-+G4briel720+-+Qu4nt1c0.S02E01.720p.Leg.mp4?mime=true"/>
      <source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/QNTCS02EP01.mp4" data-quality="hd"/>
		</video>     
        <h4>Quantico T02EP01 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
