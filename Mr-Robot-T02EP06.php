...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
	...
	<source src="https://1fgqftf.oloadcdn.net/dl/l/9P0D7KDJr30/Q_hKf1aAOow/Série sOnlineHD.org+-+G4briel720+-+%24r.R4qu1.S02E06.720p.Leg.mp4?mime=true" type="video/mp4">
	</source>
	</video>
        <h4>Mr. Robot T02EP06 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
