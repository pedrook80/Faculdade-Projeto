...
<title>Stalker</title>
<link href="css/bootstrap(stalker).css" rel="stylesheet" type="text/css">
</head>
<body>	
<!-- Main Container -->
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Stalker.php"><img src="images/stalker.jpg" alt="" width="2000" class="cards"/></a>
      <h4>STALKER</h4>
      <p class="tag">Uma dupla de detetives precisa lidar com incidentes envolvendo perseguidores para a Unidade de Gerenciamento de Ameaças da Polícia de Los Angeles.</p> 
      	<p>Criado por: Kevin Williamson (2014)</p>
		<p>Gênero: Drama, Policial, Suspense</p>
		<p>País: EUA</p>
		<p>Atores: Dylan McDermott, Maggie Q, Mariana Klaveno, mais ...</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Stalker T01EP01</a></li>
            <li><a href="#" class="text">Stalker T01EP02</a></li>
            <li><a href="#" class="text">Stalker T01EP03</a></li>
            <li><a href="#" class="text">Stalker T01EP04</a></li>
            <li><a href="#" class="text">Stalker T01EP05</a></li>
            <li><a href="#" class="text">Stalker T01EP06</a></li>
            <li><a href="#" class="text">Stalker T01EP07</a></li>
            <li><a href="#" class="text">Stalker T01EP08</a></li>
            <li><a href="#" class="text">Stalker T01EP09</a></li>
            <li><a href="#" class="text">Stalker T01EP10</a></li>
            <li><a href="#" class="text">Stalker T01EP11</a></li>
            <li><a href="#" class="text">Stalker T01EP12</a></li>
            <li><a href="#" class="text">Stalker T01EP13</a></li>
            <li><a href="#" class="text">Stalker T01EP14</a></li>
            <li><a href="#" class="text">Stalker T01EP15</a></li>
            <li><a href="#" class="text">Stalker T01EP16</a></li>
            <li><a href="#" class="text">Stalker T01EP17</a></li>
            <li><a href="#" class="text">Stalker T01EP18</a></li>
            <li><a href="#" class="text">Stalker T01EP19</a></li>
            <li><a href="#" class="text">Stalker T01EP20</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
