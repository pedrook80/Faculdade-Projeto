...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGST04EP06.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	...
       	<video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		...
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=fbb12df363b5faf4&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1488043410&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=3F32BAF64A7AB1314FA9D109D02299BEB7F5629E.227FE490924703DE63E181EA3694B32D1E3F2D81&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGST04EP06.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T04EP06</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
