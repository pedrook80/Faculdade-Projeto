...
<title>Shadowhunters T01EP04</title>
<script>
...
<div class="container"> 
  ...
  <div class="gallery">
  		<div class="thumbnail">
        <iframe src="https://drive.google.com/file/d/0B2k6-T-QdNFDdG1MVGprT3lKRE0/preview" frameborder="0" width="500" class="cards" allowfullscreen></iframe>
        <h4>Shadowhunters T01EP04</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
