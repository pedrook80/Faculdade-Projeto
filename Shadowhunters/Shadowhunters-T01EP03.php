...
<title>Shadowhunters T01EP03</title>
<script>
...
<div class="container"> 
  ...
  <div class="gallery">
  		<div class="thumbnail">
        <iframe src="https://drive.google.com/file/d/0B2k6-T-QdNFDMlNyUWlMUnJuRlk/preview" frameborder="0" width="500" class="cards" allowfullscreen></iframe>
        <h4>Shadowhunters T01EP03</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
