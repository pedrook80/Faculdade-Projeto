...
<link href="css/bootstrap(shadowhunters) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Shadowhunters T01EP01</title>
<script>
...
<div class="container"> 
  ...
  <div class="gallery">
  		<div class="thumbnail">
        <iframe src="https://drive.google.com/file/d/0B2k6-T-QdNFDYWY0Q3dCMWhZOEE/preview" frameborder="0" width="500" class="cards" allowfullscreen></iframe>
        <h4>Shadowhunters T01EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
