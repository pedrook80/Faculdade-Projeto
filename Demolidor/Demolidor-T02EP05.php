...
<link href="css/bootstrap(demolidor) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Demolidor T02EP05</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
           <iframe src="https://drive.google.com/file/d/0ByXdvZYQb8RpdjhfQlRfYl9EcTA/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>Demolidor T02EP05</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
