...
<div class="container"> 
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer09/ondemand/VKGST03EP07.mp4?rel=0&autoplay=1" target="video1.php"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	<iframe name="video1" id="video1" class="cards" width="500px" src="" frameborder="1" allowfullscreen></iframe>
        <h4>Vikings T03EP07</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
