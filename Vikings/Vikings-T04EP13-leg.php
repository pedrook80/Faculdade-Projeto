...
<title>Vikings T04EP13 LEGENDADO</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGSS04EP13.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	...
       	<video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		...
      		<source type="video/mp4" src="https://tusfiles.net/vidembed-sho4yog5v4dr"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGSS04EP13.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T04EP13 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
