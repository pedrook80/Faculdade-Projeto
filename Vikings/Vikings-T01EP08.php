...
<div class="container"> 
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP08.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
        ...
        <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=4098a94a1b58e937&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1487610147&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=ACCE9CAD55058FFCAAA7FD98AC73CB40CE59B50C.1FEDA0D15E4D01EDED78991AA83E5335335DA1A3&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP08.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T01EP08</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
