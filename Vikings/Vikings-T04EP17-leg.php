...
<title>Vikings T04EP17 LEGENDADO</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGSS04EP17.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	...
       	<video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		...
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=4dfb6907a7d7f494&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1488301162&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=9724D9B5D5AA55D27481B3B0DF47F0ACEB1E4EEB.B400A468615614B92E2E222ED2871BF9A13833A&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGSS04EP17.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T04EP17 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
