...
<div class="container"> 
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP01.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
        ...
        <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=b2db5d25e72f2a10&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1487609166&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=2109866E5917843F1D1ECD6C429A2B421B8612B4.3606390C8E1E722FF3E5F765DA1E86D94B141A5F&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP01.mp4" data-quality="hd"/>
		</video>
       <h4>Vikings T01EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
