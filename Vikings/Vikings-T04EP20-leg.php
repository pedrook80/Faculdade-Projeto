...
<title>Vikings T04EP20 LEGENDADO</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGSS04EP20.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	...
       	<video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		<!--<source type="video/mp4" src="http://dl2.my98music.com/Data/Serial/Vikings/Season%204/Vikings%20S04E03%20480p%20HDTV%20%5bFilmia%5d.mkv"/>-->
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=c3a3d227a8c13a0c&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1488301610&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=AC1F991C1686A1E5C6B21A3600740BEBA8E9A5FF.B781AB71B48425B7E2E887E02A5B3C0DA4DE888D&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGSS04EP20.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T04EP20 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
