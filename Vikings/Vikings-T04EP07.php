...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGST04EP07.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	...
       	<video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		...
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=6a735359d9350b1e&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1488043495&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=B46099064DF146EFF0C4A77C018A9DA6962FE95C.254F416E1B4FA0FC5B959848D74F1E8534BBE20D&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer11/ondemand/VKGST04EP07.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T04EP07</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
