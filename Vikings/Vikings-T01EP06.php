...
<div class="container"> 
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP06.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
        ...
        <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=1a13bc1eaf8e61f5&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1487610035&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=2765CAB92882A94814708DB5628D64096869FCAE.AEE9A52DA07CBD8F3E1889460996A0CF4B997B39&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP06.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T01EP06</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
