...
<div class="container"> 
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP02.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
        ...
        <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=33bb4856b203eb80&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1487609332&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=A2D2FD17CD9F13B17F0B7DE6FFB06BC8321AF035.3BF023537A3B64D68569B8EEDD2B991ACC9DF60B&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP02.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T01EP02</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
