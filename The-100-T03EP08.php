...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0B4q2GIxE2zB5eElONER4elg3WFk/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen frameborder="0"></iframe>
        <h4>The 100 T03EP08</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
