...
<title>Unreal</title>
<link href="css/bootstrap(unreal).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="UnReal.php"><img src="images/unreal.jpg" alt="" width="2000" class="cards"/></a>
      <h4><span style="color:#D3230D">UN</span>REAL</h4>
      <p class="tag">Nos bastidores de um Programa de TV, Rachel (Shiri Appleby) é a assistente de palco responsável por manipular as ações e reações dos participantes. Acompanhe o caos por trás das câmeras da produção de um programa de TV sobre namoro.</p>
      	<p>Criado por: Marti Noxon, Sarah Gertrude Shapiro (2015)</p>
		<p>Gênero: Drama</p>
		<p>País: EUA</p>
		<p>Atores: Constance Zimmer, Shiri Appleby, Josh Kelly, mais...</p>
		...
		<h3 class="thumb22"><span>2ª Temporada</span></h3>
            ...
            <li><a href="UnReal-T02EP01.php" class="text">UnReal T02EP01 (Legendado)</a></li>
            <li><a href="#" class="text">UnReal T02EP02 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">UnReal T02EP03 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">UnReal T02EP04 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">UnReal T02EP05 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">UnReal T02EP06 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">UnReal T02EP07 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">UnReal T02EP08 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">UnReal T02EP09 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">UnReal T02EP10 <strong style="color:green">(Em Breve)</strong></a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
