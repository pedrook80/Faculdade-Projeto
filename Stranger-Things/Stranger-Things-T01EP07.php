...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0B0jgAtZrEVW0dUtNNmlXLU14SHM/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>        <h4>Stranger Things T01EP07</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
