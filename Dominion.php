...
<link href="css/bootstrap(dominion).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Dominion.php"><img src="images/dominion.jpg" alt="" width="2000" class="cards"/></a>
      <h4>DOMINION</h4>
      <p class="tag">Deus desapareceu e, em sua ausência, o arcanjo Gabriel declarou guerra à criação. Em meio ao conflito entre anjos e homens, um jovem soldado rebelde descobre ser o improvável salvador da humanidade. Ele deve proteger Vega, a última fortaleza da humanidade.</p> 
      <p class="text_column2">Criado por: Vaun Wilmott (2014)</p>
      <p class="text_column2">Gênero: Ação, Aventura, Fantasia</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Christopher Egan, Tom Wisdom,  mais ...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Dominion T01EP01</a></li>
            <li><a href="#" class="text">Dominion T01EP02</a></li>
            <li><a href="#" class="text">Dominion T01EP03</a></li>
            <li><a href="#" class="text">Dominion T01EP04</a></li>
            <li><a href="#" class="text">Dominion T01EP05</a></li>
            <li><a href="#" class="text">Dominion T01EP06</a></li>
            <li><a href="#" class="text">Dominion T01EP07</a></li>
            <li><a href="#" class="text">Dominion T01EP08</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="#" class="text">Dominion T02EP01</a></li>
            <li><a href="#" class="text">Dominion T02EP02</a></li>
            <li><a href="#" class="text">Dominion T02EP03</a></li>
            <li><a href="#" class="text">Dominion T02EP04</a></li>
            <li><a href="#" class="text">Dominion T02EP05</a></li>
            <li><a href="#" class="text">Dominion T02EP06</a></li>
            <li><a href="#" class="text">Dominion T02EP07</a></li>
            <li><a href="#" class="text">Dominion T02EP08</a></li>
            <li><a href="#" class="text">Dominion T02EP09</a></li>
            <li><a href="#" class="text">Dominion T02EP10</a></li>
            <li><a href="#" class="text">Dominion T02EP11</a></li>
            <li><a href="#" class="text">Dominion T02EP12</a></li>
            <li><a href="#" class="text">Dominion T02EP13</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
