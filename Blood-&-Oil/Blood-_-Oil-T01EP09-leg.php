...
<link href="css/bootstrap(blood-and) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Blood & Oil T01EP09</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<iframe src="https://drive.google.com/file/d/0B1WQChdCv4fHOWFaM212bG5vNm8/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>Blood & Oil T01EP09 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
