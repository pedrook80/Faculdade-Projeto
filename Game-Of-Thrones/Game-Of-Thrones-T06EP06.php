...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="http://dropshare.biz/player/embed.php?fid=3851&key=MTExMTQwMzQxNw==&servidor=19660" width="500" class="cards" allowfullscreen></iframe>
        <h4>Game Of Thrones T06EP06</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
