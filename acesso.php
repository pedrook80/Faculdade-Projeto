  ...
  <div class=" menu-item-43">
    <nav id="menu" class="container">
      <ul id="menu-top-menu" class="sf-menu">
        ...
        <li id="menu-item-37"><a href="netflix.php">Seção Netflix</a></li>
        <li id="menu-item-38"><a href="login.php"><u>Login / Cadastro</u></a></li>
		  </ul>
    </nav></div>
        ...
        <option value="netflix.php">Seção Netflix</option>
    	</select>
  <div class="gallery">
    <div class="thumbnail">
