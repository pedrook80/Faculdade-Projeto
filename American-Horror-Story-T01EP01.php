...
<title>American Horror Story T01EP01</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://docs.google.com/file/d/0B5gsj1mpy18-d3hJdUxRa0J5Tkk/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>American Horror Story T01EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
