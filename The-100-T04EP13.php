...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       		<video class="afterglow" id="myvideo" poster="images/The 100 3.jpg" width="500" height="250" data-autoresize="fit" src="http://cdnv3.ec.cx/RedeCanais/RedeCanais/RCServer12/ondemand/THE100T04EP13.mp4" type="video/mp4" data-quality="hd"></video>
        <h4>The 100 T04EP13</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
