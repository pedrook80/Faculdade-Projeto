...
<title>Lucifer T02EP04 LEGENDADO</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="options">
        <ul id="options">
          <li><a href="https://ok.ru/videoembed/89935186567?rel=0&autoplay=1" target="video1.php"> OPÇÃO 1</a></li>
      </ul>
    <ul id="options1"><li><a href="http://transforrede.com/vd/dd/RC/RCServer11/ondemand/LCFRS02EP04.mp4?rel=0&autoplay=1" target="video1.php"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	<iframe name="video1" id="video1" class="cards" width="500px" src="" frameborder="1" allowfullscreen></iframe>
        <h4>Lucifer T02EP04 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
