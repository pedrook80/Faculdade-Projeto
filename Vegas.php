...
<title>Vegas</title>
<link href="css/bootstrap(vegas).css" rel="stylesheet" type="text/css">
</head>
<body>	
<!-- Main Container -->
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Vegas.php"><img src="images/vegas.jpg" alt="" width="2000" class="cards"/></a>
      	<h4>Vegas</h4>
      	<p class="tag">Baseada em uma história real, conta o drama do Xerife Ralph Lamb (Dennis Quaid), um rancheiro com a tarefa de trazer ordem a Las Vegas, nos anos 1960. Ele só quer ser deixado em paz no seu rancho, mas Las Vegas está cada vez mais lotada de estranhos e corruptos, interrompendo a vida simples. O prefeito, relembrando os tempos de Lamb como militar, apela para seu olhar apurado para investigar um assassinato - dando início ao embate de Ralph com Vincent Savino (Michael Chiklis), um gângster de Chicago que planeja tomar Vegas para si.</p>
      	<p>Criado por: 	Nicholas Pileggi (2012)</p>
		<p>Gênero: Drama, Faroeste</p>
		<p>País: EUA</p>
		<p>Atores: Dennis Quaid, Michael Chiklis, Jason O'Mara mais...</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Vegas T01EP01</a></li>
            <li><a href="#" class="text">Vegas T01EP02</a></li>
            <li><a href="#" class="text">Vegas T01EP03</a></li>
            <li><a href="#" class="text">Vegas T01EP04</a></li>
            <li><a href="#" class="text">Vegas T01EP05</a></li>
            <li><a href="#" class="text">Vegas T01EP06</a></li>
            <li><a href="#" class="text">Vegas T01EP07</a></li>
            <li><a href="#" class="text">Vegas T01EP08</a></li>
            <li><a href="#" class="text">Vegas T01EP09</a></li>
            <li><a href="#" class="text">Vegas T01EP10</a></li>
            <li><a href="#" class="text">Vegas T01EP11</a></li>
            <li><a href="#" class="text">Vegas T01EP12</a></li>
            <li><a href="#" class="text">Vegas T01EP13</a></li>
            <li><a href="#" class="text">Vegas T01EP14</a></li>
            <li><a href="#" class="text">Vegas T01EP15</a></li>
            <li><a href="#" class="text">Vegas T01EP16</a></li>
            <li><a href="#" class="text">Vegas T01EP17</a></li>
            <li><a href="#" class="text">Vegas T01EP18</a></li>
            <li><a href="#" class="text">Vegas T01EP19</a></li>
            <li><a href="#" class="text">Vegas T01EP20</a></li>
            <li><a href="#" class="text">Vegas T01EP21</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
