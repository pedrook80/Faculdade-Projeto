...
<div class=" menu-item-43">
  ...
  <div class="gallery">
	...
	<source src="https://pgli88.oloadcdn.net/dl/l/EAwn56sfiZI/XXvbH2QebLM/Mr.Robot.S02E07.Legendado.mp4?mime=true" type="video/mp4">
	</source>
	</video>
        <h4>Mr. Robot T02EP07 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
