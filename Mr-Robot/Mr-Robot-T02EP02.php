...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
	...
	<source src="https://1fgm901.oloadcdn.net/dl/l/dnbN357ci4s/kEMtpzhbHx4/MR.Robot_2.02.480pLEGa?mime=true" type="video/mp4">
	</source>
	</video>
        <h4>Mr. Robot T02EP02</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
