...
<div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video width="500" autoplay controls class="cards" src="https://prisma1.azureedge.net/d/RCServer11/ondemand/MROBS02EP11.mp4" type="video/mp4"><h4>Mr. Robot T02EP11 <strong style="color:#FF0000">Legendado</strong> <strong style="color:#FF0000">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
