...
<title>Mr. Robot T01EP04</title></head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
        <iframe src="https://drive.google.com/file/d/0Bxe6ti56KANYNTYyOExXczB2SEE/preview?rel=0&autoplay=1" width="500" class="cards" allowfulllscreen></iframe>
        <h4>Mr. Robot T01EP04</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
