...
<div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="?rel=0&autoplay=1" width="500" frameborder="0" allowfullscreen class="cards"></iframe>
        <h4>Mr. Robot T02EP12 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
