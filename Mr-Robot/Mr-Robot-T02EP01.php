 ...
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
			...
			<source src="https://1fgm8qw.oloadcdn.net/dl/l/uyeMIjGRzRo/TRE4GIV7Yfw/MR.Robot_2.01.480pLEGa?mime=true" type="video/mp4">
			</source>
	</video>
        <h4>Mr. Robot T02EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
