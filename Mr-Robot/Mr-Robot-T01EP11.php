...
<title>Mr. Robot T01EP11</title></head>
<body>
<!-- Main Container -->
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video width="500" controls autoplay class="cards">
			<source src="https://oqt1pa.oloadcdn.net/dl/l/fWgcEDWDRzo/Oi-JnYbO4og/%241nh0.R0b0.S02E00.720p.Leg.mp4?mime=true" type="video/mp4"></source></video>
        <h4>Mr. Robot T01EP11</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
