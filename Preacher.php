...
<link href="css/bootstrap(preacher).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Preacher.php"><img src="images/Preacher.jpg" alt="" width="2000" class="cards"/></a>
      <h4>PREACHER</h4>
      <p class="tag">Jesse Custer é um ex-pastor que foi possuído por uma entidade que fugiu do Paraíso e está sendo procurada pelos anjos. Quando Jesse e Gênesis se tornam um só, os anjos enviam o Santo dos Assassinos, um matador do Século XIX, para perseguí-lo.</p>
      	<p>Criado por: Seth Rogen, Evan Goldberg (2016)</p>
		<p>Gênero: Fantasia, Terror</p>
		<p>País: EUA</p>
		<p>Atores: Dominic Cooper, Joseph Gilgun, Ruth Negga, mais...</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="Preacher-T01EP01.php" class="text">Preacher T01EP01</a></li>
            <li><a href="Preacher-T01EP02.php" class="text">Preacher T01EP02</a></li>
            <li><a href="Preacher-T01EP03.php" class="text">Preacher T01EP03</a></li>
            <li><a href="Preacher-T01EP04.php" class="text">Preacher T01EP04</a></li>
            <li><a href="Preacher-T01EP05.php" class="text">Preacher T01EP05</a></li>
            <li><a href="#" class="text">Preacher T01EP06 <strong style="color:green">EM BREVE</strong></a></li>
            <li><a href="#" class="text">Preacher T01EP07 <strong style="color:green">EM BREVE</strong></a></li>
            <li><a href="#" class="text">Preacher T01EP08 <strong style="color:green">EM BREVE</strong></a></li>
            <li><a href="#" class="text">Preacher T01EP09 <strong style="color:green">EM BREVE</strong></a></li>
            <li><a href="#" class="text">Preacher T01EP10 <strong style="color:green">EM BREVE</strong></a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
