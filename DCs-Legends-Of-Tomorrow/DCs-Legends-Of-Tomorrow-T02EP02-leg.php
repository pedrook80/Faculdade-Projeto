...
<title>DC's Legends Of Tomorrow T02EP02 <span style="color:#FF0000"> LEGENDADO</span></title></head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://ok.ru/video/184958782087?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>DC's Legends Of Tomorrow T02EP02 <strong style="color:#FF0000">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
