...
<title>DC's Legends Of Tomorrow T01EP13</title></head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0Bx-lVPrOrIxndkpuNUdIRDNhVmc/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>DC's Legends Of Tomorrow T01EP13</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
