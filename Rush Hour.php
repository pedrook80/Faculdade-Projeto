    ...
    <div class="thumbnail"><a href="Rush-Hour.php"><img src="images/rush-hour.jpg" alt="" width="2000" class="cards"/></a>
      ...
      <p class="tag">Jonathan Lee (Jon Foo), um rigoroso policial de Hong Kong, é destacado para acompanhar um caso em Los Angeles. Ele é forçado a trabalhar com um petulante agente americano, James Carter (Justin Hires), que não tem interesse nenhum em fazer essa parceria dar certo.</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Rush Hour T01EP01</a></li>
            <li><a href="#" class="text">Rush Hour T01EP02</a></li>
            <li><a href="#" class="text">Rush Hour T01EP03</a></li>
            <li><a href="#" class="text">Rush Hour T01EP04</a></li>
            <li><a href="#" class="text">Rush Hour T01EP05</a></li>
            <li><a href="#" class="text">Rush Hour T01EP06</a></li>
            <li><a href="#" class="text">Rush Hour T01EP07</a></li>
            <li><a href="#" class="text">Rush Hour T01EP08</a></li>
            <li><a href="#" class="text">Rush Hour T01EP09</a></li>
            <li><a href="#" class="text">Rush Hour T01EP10</a></li>
            <li><a href="#" class="text">Rush Hour T01EP11</a></li>
            <li><a href="#" class="text">Rush Hour T01EP12</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
