...
<link href="css/bootstrap(containment).css" rel="stylesheet" type="text/css">
</head>
<body>	
<!-- Main Container -->
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Containment.php"><img src="images/containment.jpg" alt="" width="2000" class="cards"/></a>
      <h4>CONTAINMENT</h4>
      <p class="tag">Uma misteriosa e mortal epidemia atinge Atlanta, o que força o governo americano a colocar a cidade em quarentena. O policial de bom coração Alex Carnahan (David Gyasi), mais conhecido como Lex, é o responsável por patrulhar a área, onde está sua namorada, a inteligente Jana (Christina Moses). Dentre eles também está Jake (Chris Wood), um ex-renegado que agora atua como policial. Melhor amigo de Lex, ele deve proteger os mais necessitas, mas seu primeiro instinto é sempre salvar a si próprio. Os moradores que ficaram “presos” enfrentarão uma sinistra luta por sobrevivência.</p> 
      <p class="text_column2">Criado por: Julie Plec (2016)</p>
      <p class="text_column2">Gênero: Drama</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: David Gyasi, Christina Moses, Chris Wood, mais...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Containment T01EP01</a></li>
            <li><a href="#" class="text">Containment T01EP02</a></li>
            <li><a href="#" class="text">Containment T01EP03</a></li>
            <li><a href="#" class="text">Containment T01EP04</a></li>
            <li><a href="#" class="text">Containment T01EP05</a></li>
            <li><a href="#" class="text">Containment T01EP06</a></li>
            <li><a href="#" class="text">Containment T01EP07</a></li>
            <li><a href="#" class="text">Containment T01EP08</a></li>
            <li><a href="#" class="text">Containment T01EP09</a></li>
            <li><a href="#" class="text">Containment T01EP10</a></li>
            <li><a href="#" class="text">Containment T01EP11</a></li>
            <li><a href="#" class="text">Containment T01EP12</a></li>
            <li><a href="#" class="text">Containment T01EP13</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
