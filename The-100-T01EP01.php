...
<link rel="shortcut icon" href="iamges/vsicon.png">
<title>The 100 T01EP01</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<iframe src="https://drive.google.com/file/d/0B4q2GIxE2zB5WUFJeTRscnpIV1U/preview?rel=0&autoplay=1" width="500" allowfullscreen class="cards"></iframe>
        <h4>The 100 T01EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
