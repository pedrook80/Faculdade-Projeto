...
<title>Agents of S.H.I.E.L.D T01EP17</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://transforrede.com/vd/dd/RC/RCServer08/ondemand/AGTOSHLDT01EP17.mp4?rel=0&autoplay=1" target="video1.php"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	<iframe name="video1" id="video1" class="cards" width="500px" src="0" frameborder="1" allowfullscreen></iframe>
        <h4>Agents Of S.H.I.E.L.D T01EP17</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
