...
<link href="css/bootstrap(black-sails).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a><img class="cards" src="images/black-sails.jpg" alt="Assista série online." width="2000"/></a>
    <h4>Black Sails</h4>
		<p class="tag">Ambientada 20 anos antes dos eventos que se sucedem no livro “Ilha do Tesouro”, de Robert Louis Stevenson, acompanha as aventuras do Capitão Flint (Toby Stephens) e sua tripulação. Os ataques brutais e os saques cometidos pelos marujos quase provocam a sua extinção, e Flint procura refúgio na ilha de New Providence, uma espécie de paraíso pirata definido tanto por seus ideiais iluministas quanto pela assombrosa brutalidade. Em sua jornada, o Capitão acaba ganhando um jovem e falante agregado para sua equipe: um certo John Silver (Luke Arnold).</p>
      <p class="text_column2">Criado por: Jonathan E. Steinberg, Robert Levine (2014)</p>
      <p class="text_column2">Gênero: Aventura</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: BToby Stephens, Hannah New, Luke Arnold, mais ...</p>
      <p class="text_column2">Status: Em produção</p>
      <p class="text_column2">Duração: 52 minutos</p>
		<div class="ver"></div>
		<h3></h3>
			<div id="epsetemps">
            	<h3 class="thumb22">1ª e 2ª Temporada em breve</h3></div>
        		<!--<h3 class="thumb22"><span>1ª Temporada</span></h3><ul class="temps" id="temp1">
            <li><a href="#" class="text">Black Sails T01EP01</a></li>
            <li><a href="#" class="text">Black Sails T01EP02</a></li>
            <li><a href="#" class="text">Black Sails T01EP03</a></li>
            <li><a href="#" class="text">Black Sails T01EP04</a></li>
            <li><a href="#" class="text">Black Sails T01EP05</a></li>
            <li><a href="#" class="text">Black Sails T01EP06</a></li>
            <li><a href="#" class="text">Black Sails T01EP07</a></li>
            <li><a href="#" class="text">Black Sails T01EP08</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="#" class="text">Black Sails T02EP01</a></li>
            <li><a href="#" class="text">Black Sails T02EP02</a></li>
            <li><a href="#" class="text">Black Sails T02EP03</a></li>
            <li><a href="#" class="text">Black Sails T02EP04</a></li>
            <li><a href="#" class="text">Black Sails T02EP05</a></li>
            <li><a href="#" class="text">Black Sails T02EP06</a></li>
            <li><a href="#" class="text">Black Sails T02EP07</a></li>
            <li><a href="#" class="text">Black Sails T02EP08</a></li>
            <li><a href="#" class="text">Black Sails T02EP09</a></li>
            <li><a href="#" class="text">Black Sails T02EP10</a></li>
                </ul></div>-->
			<h3 class="heading"><span>3ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="Black-Sails-T03EP01-leg.php" class="text">Black Sails T03EP01 Legendado</a></li>
            <li><a href="Black-Sails-T03EP02-leg.php" class="text">Black Sails T03EP02 Legendado</a></li>
            <li><a href="Black-Sails-T03EP03-leg.php" class="text">Black Sails T03EP03 Legendado</a></li>
            <li><a href="Black-Sails-T03EP04-leg.php" class="text">Black Sails T03EP04 Legendado</a></li>
            <li><a href="Black-Sails-T03EP05-leg.php" class="text">Black Sails T03EP05 Legendado</a></li>
            <li><a href="Black-Sails-T03EP06-leg.php" class="text">Black Sails T03EP06 Legendado</a></li>
            <li><a href="Black-Sails-T03EP07-leg.php" class="text">Black Sails T03EP07 Legendado</a></li>
            <li><a href="Black-Sails-T03EP08-leg.php" class="text">Black Sails T03EP08 Legendado</a></li>
            <li><a href="Black-Sails-T03EP09-leg.php" class="text">Black Sails T03EP09 Legendado</a></li>
            <li><a href="Black-Sails-T03EP10-leg.php" class="text">Black Sails T03EP10 Legendado</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
