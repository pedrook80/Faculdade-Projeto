...
<link href="css/bootstrap(agent) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Agent Carter T01EP01</title>
</head>
<body>
<!-- Main Container -->
<div class="container"> 
  <!-- Header -->
  <header class="header">
    <h4 class="logo"><!--<a href=".php"></a>-->VIA SÉRIE </h4>
  </header>
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<iframe src="https://drive.google.com/file/d/0Bxe6ti56KANYMkIyeGgySHNvZWM/preview?rel=0&autoplay=1" width="500" class="cards"></iframe>
        <h4>Agent Carter T01EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
