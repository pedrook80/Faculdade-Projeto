...
<title>The Walking Dead T07EP05</title>
</head>
<body>
<!-- Main Container -->
<div class="container"> 
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
        <iframe src="http://cdn.ec.cx/vd/dd/RC/RCServer11/ondemand/TWDT07EP05.mp4?rel=0&autoplay=1" width="500" frameborder="0" class="cards" allowfullscreen></iframe>
        <h4>The Walking Dead T07EP05</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
