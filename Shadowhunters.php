...
<link href="css/bootstrap(shadowhunters).css" rel="stylesheet" type="text/css">
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Shadowhunters.php"><img src="images/shadowhunters.jpg" alt="" width="2000" class="cards"/></a>
      <h4>SHADOWHUNTERS</h4>
      <p class="tag">Clary (Katherine McNamara) é uma adolescente comum que, sem querer, presencia um assassinato dos “Caçadores de Sombras”. Ela se unirá ao grupo de misteriosos guerreiros para aventurar-se no perigoso mundo das sombras, a fim de encontrar pistas sobre o paradeiro de sua mãe desaparecida.</p>
      	<p>Criado por: McG, Ed Decter (2016)</p>
		<p>Gênero: Ação, Fantasia</p>
		<p>País: EUA</p>
		<p>Atores: Katherine McNamara, Dominic Sherwood, Alberto Rosende, </p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="Shadowhunters-T01EP01.php" class="text">Shadowhunters T01EP01</a></li>
            <li><a href="Shadowhunters-T01EP02.php" class="text">Shadowhunters T01EP02</a></li>
            <li><a href="Shadowhunters-T01EP03.php" class="text">Shadowhunters T01EP03</a></li>
            <li><a href="Shadowhunters-T01EP04.php" class="text">Shadowhunters T01EP04</a></li>
            <li><a href="Shadowhunters-T01EP05.php" class="text">Shadowhunters T01EP05</a></li>
            <li><a href="Shadowhunters-T01EP06.php" class="text">Shadowhunters T01EP06</a></li>
            <li><a href="#" class="text">Shadowhunters T01EP07 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="Shadowhunters-T01EP08.php" class="text">Shadowhunters T01EP08</a></li>
            <li><a href="#" class="text">Shadowhunters T01EP09 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">Shadowhunters T01EP10 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">Shadowhunters T01EP11 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="#" class="text">Shadowhunters T01EP12 <strong style="color:green">(Em Breve)</strong></a></li>
            <li><a href="Shadowhunters-T01EP13.php" class="text">Shadowhunters T01EP13</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
