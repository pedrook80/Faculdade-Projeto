...
<title>Shadowhunters T01EP02</title>
<script>
...
<div class="container"> 
  ...
  <div class="gallery">
  		<div class="thumbnail">
        <iframe src="https://drive.google.com/file/d/0B2k6-T-QdNFDUkpwWjFhZGFIN0k/preview" frameborder="0" width="500" class="cards" allowfullscreen></iframe>
        <h4>Shadowhunters T01EP02</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
