...
<div class="container"> 
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0B8PCftBQyHmhRzEwNlNManNUR1U/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>Breaking Bad T01EP02 <strong style="color">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
