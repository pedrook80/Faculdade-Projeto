...
<link href="css/bootstrap(rush-hour).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Rush-Hour.php"><img src="images/rush-hour.jpg" alt="" width="2000" class="cards"/></a>
      <h4>RUSH HOUR</h4>
      <p class="tag">Jonathan Lee (Jon Foo), um rigoroso policial de Hong Kong, é destacado para acompanhar um caso em Los Angeles. Ele é forçado a trabalhar com um petulante agente americano, James Carter (Justin Hires), que não tem interesse nenhum em fazer essa parceria dar certo.</p>
      	<p>Criado por: Blake McCormick, Bill Lawrence, Steve Franks (2016)</p>
		<p>Gênero: Ação, Comédia, Policial</p>
		<p>País: EUA</p>
		<p>Atores: Justin Hires, Jon Foo, Aimee Garcia, mais ...</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Rush Hour T01EP01 <strong style="color:green">(Em breve)</strong></a></li>
            <li><a href="#" class="text">Rush Hour T01EP02 <strong style="color:green">(Em breve)</strong></a></li>
            <li><a href="#" class="text">Rush Hour T01EP03 <strong style="color:green">(Em breve)</strong></a></li>
            <li><a href="#" class="text">Rush Hour T01EP04 <strong style="color:green">(Em breve)</strong></a></li>
            <li><a href="Rush-Hour-T01EP05.php" class="text">Rush Hour T01EP05</a></li>
            <li><a href="#" class="text">Rush Hour T01EP06 <strong style="color:green">(Em breve)</strong></a></li>
            <li><a href="Rush-Hour-T01EP07.php" class="text">Rush Hour T01EP07</a></li>
            <li><a href="Rush-Hour-T01EP08.php" class="text">Rush Hour T01EP08</a></li>
            <li><a href="Rush-Hour-T01EP09.php" class="text">Rush Hour T01EP09</a></li>
            <li><a href="#" class="text">Rush Hour T01EP10 <strong style="color:green">(Em breve)</strong></a></li>
            <li><a href="#" class="text">Rush Hour T01EP11 <strong style="color:green">(Em breve)</strong></a></li>
            <li><a href="#" class="text">Rush Hour T01EP12 <strong style="color:green">(Em breve)</strong></a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
