...
<link href="css/bootstrap(izombie) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>iZombie T02EP05</title>
</head>
<body>
<!-- Main Container -->
 ...
 <div class=" menu-item-43">
    <nav id="menu" class="container">
      <ul id="menu-top-menu" class="sf-menu">
        <li id="menu-item-09"><a href=".php">In�cio</a></li>
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="index.php"> In�cio</option>
  ...
  <div class="gallery">
  		<div class="thumbnail">
          <iframe src="https://drive.google.com/file/d/0B0E75r4ULyCDb2p3d0lVdHNac2s/preview?rel=0&autoplay=1" widht="500" classs="cards" alllowfullscreen></iframe>  
        <h4>iZombie T02EP05</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
