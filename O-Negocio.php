...
<title>O Negócio</title>
<link href="css/bootstrap(o-negocio).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="O-Negocio.php"><img src="images/onegocio.jpg" alt="" width="2000" class="cards"/></a>
      <h4>O NEGÓCIO</h4>
      <p class="tag">Karin (Rafaela Mandelli), Luna (Juliana Schalch) e Magali (Michelle Batista) são profissionais naquilo que fazem. Sem perspectiva de melhorar a profissão, elas percebem que por trás de qualquer bom trabalho há uma excelente estratégia de marketing. Então, por que não aplicar essas técnicas à profissão mais antiga do mundo? Assim, as três garotas de programa estão prestes a se tornar mulheres de negócio.</p>
      	<p>Criado por: Rodrigo Castilho, Luca Paiva Mello (2013)</p>
		<p>Gênero: Comédia , Drama</p>
		<p>País: </p>
		<p>Atores: Rafaela Mandelli, Juliana Schalch, Michelle Batista mais...</p>
        ...
        <!--<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="" title=".php" class="text">O Negócio T01EP01</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP02</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP03</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP04</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP05</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP06</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP07</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP08</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP09</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP10</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP11</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP12</a></li>
            <li><a href="" title=".php" class="text">O Negócio T01EP13</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="" title=".php" class="text">O Negócio T02EP01</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP02</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP03</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP04</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP05</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP06</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP07</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP08</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP09</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP10</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP11</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP12</a></li>
            <li><a href="" title=".php" class="text">O Negócio T02EP13</a></li>
                </ul></div>
			<h3 class="heading"><span>3ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="" title=".php" class="text">O Negócio T03EP01</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP02</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP03</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP04</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP05</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP06</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP07</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP08</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP09</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP10</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP11</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP12</a></li>
            <li><a href="" title=".php" class="text">O Negócio T03EP13</a></li>
            </ul></div>--></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
