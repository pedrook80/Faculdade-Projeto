...
<title>The Big Bang Theory T10EP04 (LEGENDADO)</title></head>
<body>
<!-- Main Container -->
<div class="container"> 
  <!-- Header -->
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<iframe src="https://drive.google.com/file/d/0B8PCftBQyHmhT2tIRDk5YVFTOVU/preview?rel=0&autoplay=1" frameborder="0" width="500" allowfullscreen class="cards"></iframe>
        <h4>The Big Bang Theory T10EP04 <strong style="color">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
