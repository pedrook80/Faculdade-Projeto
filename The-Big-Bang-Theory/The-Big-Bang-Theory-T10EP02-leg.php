...
<title>The Big Bang Theory T10EP02 (LEGENDADO)</title></head>
<body>
<!-- Main Container -->
<div class="container"> 
  <!-- Header -->
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
        ...
        <source src="http://rc.lella.la/vd/dd/RC/RCServer11/ondemand/TBBTS10EP02.mp4"></source></video>  
        <h4>The Big Bang Theory T10EP02 <strong style="color">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
