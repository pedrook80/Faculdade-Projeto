...
<title>The Big Bang Theory T10EP06 LEGENDADO</title></head>
<body>
<!-- Main Container -->
<div class="container"> 
  <!-- Header -->
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
		<iframe src="https://ok.ru/videoembed/185488050823?rel=0&autoplay=1" frameborder="0" width="500" allowfullscreen class="cards"></iframe>
        <h4>The Big Bang Theory T10EP06 <strong style="color">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
