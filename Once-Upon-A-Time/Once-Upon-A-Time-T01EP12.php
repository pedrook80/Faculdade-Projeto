...
<link href="css/bootstrap(once-upon) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Once Upon A Time T01EP12</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0B5Hw7NoLrMlyYzZZZFdUSUtGeHM/preview?rel=0&autoplay=1" frameborder="0" width="500" class="cards" allowfullscreen></iframe>
        <h4>Once Upon A Time T01EP12</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
