...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://cdn.ec.cx/vd/dd/RC/RCServer07/ondemand/ARROWT02EP01.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
       	<iframe name="video1" id="video1" class="cards" width="500px" src="" frameborder="1" allowfullscreen></iframe>-->
     <video class="afterglow" id="myvideo" width="800" height="500" data-autoresize="fit">
      <source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=fe4cbd55c7c861bd&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1485803165&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=9F15156FDB8EFF4E1B7D688B0D156AAAEFE430A4.6BAD6D88ACD451C311DFD037EF0B4FD839F56B86&key=ck2"/>
      <source type="video/mp4" src="http://cdn.ec.cx/vd/dd/RC/RCServer09/ondemand/ARROWT02EP01.mp4" data-quality="hd"/>
		</video>
        <h4>Arrow T02EP01</h4>
	</div></div>
        <!-- Footer Section -->
