...
<title>Outcast</title>
<link href="css/bootstrap(outcast).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Outcast.php"><img src="images/outcast.jpg" alt="" width="2000" class="cards"/></a>
      <h4>OUTCAST</h4>
      <p class="tag">Kyle Barnes é um homem atormentado por uma possessão desde a infância. Agora, ele embarca em uma jornada espiritual determinado a descobrir a verdade sobre a maldição que lhe atormenta, mesmo que isso signifique o fim da existência na Terra como a conhecemos.</p>
      	<p>Criado por: Robert Kirkman (2016)</p>
		<p>Gênero: Drama, Fantasia, Terror</p>
		<p>País: EUA</p>
		<p>Atores: Patrick Fugit, Philip Glenister, Reg E. Cathey, mais...</p>
        ...
        <!--<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="" title=".php" class="text">Outcast T01EP01</a></li>
            <li><a href="" title=".php" class="text">Outcast T01EP02</a></li>
            <li><a href="" title=".php" class="text">Outcast T01EP03</a></li>
            <li><a href="" title=".php" class="text">Outcast T01EP04</a></li>
            <li><a href="" title=".php" class="text">Outcast T01EP05</a></li>
            <li><a href="" title=".php" class="text">Outcast T01EP06</a></li>
            <li><a href="" title=".php" class="text">Outcast T01EP07</a></li>
            <li><a href="" title=".php" class="text">Outcast T01EP08</a></li>
            <li><a href="" title=".php" class="text">Outcast T01EP09</a></li>
            </ul></div>--></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
