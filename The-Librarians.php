...
<link href="css/bootstrap(the-librarians).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="The-Librarians.php"><img src="images/the-librarians.jpg" alt="" width="2000" class="cards"/></a>
      <h4>THE LIBRARIANS</h4>
      <p class="tag">Uma antiga organização escondida por detrás da Biblioteca Pública Metropolitana, dedicada a proteger um mundo desconhecido da realidade mágica e secreta que esconde. O grupo resolve mistérios impossíveis, luta contra ameaças sobrenaturais e recupera artefatos poderosos ao redor do globo.</p> 
      	<p>Criado por: John Rogers (II) (2014)</p>
		<p>Gênero: Aventura</p>
		<p>País: EUA</p>
		<p>Atores: Noah Wyle, Rebecca Romijn, Lindy Booth, mais ...</p>
        ...
        <!--<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">The Librarians T01EP01</a></li>
            <li><a href="#" class="text">The Librarians T01EP02</a></li>
            <li><a href="#" class="text">The Librarians T01EP03</a></li>
            <li><a href="#" class="text">The Librarians T01EP04</a></li>
            <li><a href="#" class="text">The Librarians T01EP05</a></li>
            <li><a href="#" class="text">The Librarians T01EP06</a></li>
            <li><a href="#" class="text">The Librarians T01EP07</a></li>
            <li><a href="#" class="text">The Librarians T01EP08</a></li>
            <li><a href="#" class="text">The Librarians T01EP09</a></li>
            <li><a href="#" class="text">The Librarians T01EP10</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="#" class="text">The Librarians T02EP01</a></li>
            <li><a href="#" class="text">The Librarians T02EP02</a></li>
            <li><a href="#" class="text">The Librarians T02EP03</a></li>
            <li><a href="#" class="text">The Librarians T02EP04</a></li>
            <li><a href="#" class="text">The Librarians T02EP05</a></li>
            <li><a href="#" class="text">The Librarians T02EP06</a></li>
            <li><a href="#" class="text">The Librarians T02EP07</a></li>
            <li><a href="#" class="text">The Librarians T02EP08</a></li>
            <li><a href="#" class="text">The Librarians T02EP09</a></li>
            <li><a href="#" class="text">The Librarians T02EP10</a></li>
			</ul></div>--></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
