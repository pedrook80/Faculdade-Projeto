...
<link href="css/bootstrap(billions).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Billions.php"><img src="images/billions22.jpg" alt="" width="2000" class="cards"/></a>
      <h4>BILLIONS</h4>
      <p class="tag">No mundo das altas finanças de Nova York, nos bastidores de Wall Street, o Procurador de Justiça Chuck Rhodes (Paul Giamatti) bate de frente com o brilhante e ambicioso Bobby “Axe” Axelrod (Damian Lewis), um dos homens mais ricos do país.</p> 
      <p class="text_column2">Criado por: Andrew Ross Sorkin, Brian Koppelman, David Levien (2016)</p>
      <p class="text_column2">Gênero: Drama</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Paul Giamatti, Damian Lewis, Maggie Siff, mais...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Billions T01EP01</a></li>
            <li><a href="#" class="text">Billions T01EP02</a></li>
            <li><a href="#" class="text">Billions T01EP03</a></li>
            <li><a href="#" class="text">Billions T01EP04</a></li>
            <li><a href="#" class="text">Billions T01EP05</a></li>
            <li><a href="#" class="text">Billions T01EP06</a></li>
            <li><a href="#" class="text">Billions T01EP07</a></li>
            <li><a href="#" class="text">Billions T01EP08</a></li>
            <li><a href="#" class="text">Billions T01EP09</a></li>
            <li><a href="#" class="text">Billions T01EP10</a></li>
            <li><a href="#" class="text">Billions T01EP11</a></li>
            <li><a href="#" class="text">Billions T01EP12</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
