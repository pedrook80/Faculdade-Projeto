...
<link href="css/bootstrap(terra-nova).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Terra-Nova.php"><img src="images/terra-nova.jpg" alt="" width="2000" class="cards"/></a>
      <h4>TERRA NOVA</h4>
      <p class="tag">No ano de 2149, o planeta Terra está praticamente inabitável pelo excesso de poluição da atmosfera. Para escapar dessa situação, o detetive de polícia Jim Shannon (Jason O'Mara) resolve viajar com a mulher, Dra. Elisabeth (Shelley Conn), e os filhos para Terra Nova, uma colônia humana em plena era dos dinossauros. Em pouco tempo, Jim é recrutado pelo comandante Nathaniel Taylor (Stephen Lang) para cuidar da segurança do local e logo descobre que irá enfrentar diferentes ameaças na sua nova vida.</p>
      	<p>Criado por: 	Craig Silverstein, Kelly Marcel (2011)</p>
		<p>Gênero: Drama</p>
		<p>País: EUA</p>
		<p>Atores: Jason O'Mara, Shelley Conn, Stephen Lang mais...</p>
        ...
        <!--<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Terra Nova T01EP01</a></li>
            <li><a href="#" class="text">Terra Nova T01EP02</a></li>
            <li><a href="#" class="text">Terra Nova T01EP03</a></li>
            <li><a href="#" class="text">Terra Nova T01EP04</a></li>
            <li><a href="#" class="text">Terra Nova T01EP05</a></li>
            <li><a href="#" class="text">Terra Nova T01EP06</a></li>
            <li><a href="#" class="text">Terra Nova T01EP07</a></li>
            <li><a href="#" class="text">Terra Nova T01EP08</a></li>
            <li><a href="#" class="text">Terra Nova T01EP09</a></li>
            <li><a href="#" class="text">Terra Nova T01EP10</a></li>
            <li><a href="#" class="text">Terra Nova T01EP11</a></li>
            <li><a href="#" class="text">Terra Nova T01EP12</a></li>
            <li><a href="#" class="text">Terra Nova T01EP13</a></li>
            </ul></div>--></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
