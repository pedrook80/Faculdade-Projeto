...
<link href="css/bootstrap(touch) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Touch T01EP01</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
        ...
        <source src="http://proxy-069.dc3.dailymotion.com/sec(8bb452e3559f0208ff073d0dea2eb373)/video/314/286/298682413_mp4_h264_aac_hq.m3u8"></source></video>
        <h4>Touch T01EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
