...
<link href="css/bootstrap(scram-queens).css" rel="stylesheet" type="text/css">
</head>
<body>	
<!-- Main Container -->
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Scream-Queens.php"><img src="images/scream-queens.jpg" alt="" width="2000" class="cards"/></a>
      <h4>SCREAM QUEENS</h4>
      <p class="tag">Antologia de comédia e terror que se inicia em uma faculdade dos Estados Unidos, onde uma série de assassinatos começa a acontecer de forma misteriosa.</p>
      	<p>Criado por: Ryan Murphy, Brad Falchuk, Ian Brennan (2015)</p>
		<p>Gênero: Comédia, Terror</p>
		<p>País: EUA</p>
		<p>Atores: Emma Roberts, Jamie Lee Curtis, Skyler Samuels, mais ...</p>
		<p>Status: Em produção</p>
		<p>Duração: 42 minutos</p>
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
			<div id="epsetemps">
        		<ul class="temps" id="temp1">
            <li><a href="" title=".php" class="text">Scream Queens T01EP01</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP02</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP03</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP04</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP05</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP06</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP07</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP08</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP09</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP10</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP11</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP12</a></li>
            <li><a href="" title=".php" class="text">Scream Queens T01EP13</a></li>
            </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
