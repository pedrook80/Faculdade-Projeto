...
<title>Agent Carter</title>
<link href="css/bootstrap(agentcarter).css" rel="stylesheet" type="text/css">
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"> <a href=""><img src="images/agent carter.jpg" alt="" width="2000" class="cards"/></a>
      <h4>AGENT CARTER</h4>
      <p class="tag">Agent Carter conta a história Peggy Carter (Hayley Atwell). O ano é 1946, e Peggy se encontra marginalizada quando os homens retornam ao lar após a Guerra. Trabalhando para a SSR (Reserva Científica Estratégica, em inglês), Peggy precisa balancearo trabalho administrativo e missões secretas para Howard Stark, ao mesmo tempo em que leva uma vida solteira após perder o seu amor, Steve Rogers.</p>
      <p class="text_column2">Criado por: Tara Butters, Michele Fazekas (2015)</p>
	<p class="text_column2">Gênero: Ação, Drama, Espionagem</p>
	<p class="text_column2">País: EUA</p>
	<p class="text_column2">Atores: Hayley Atwell, James d'Arcy, Chad Michael Murray, mais ...</p>
	...
	<p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="Agent-Carter-T01EP01.php" class="text">Agent Carter T01EP01</a></li>	
            <li><a href="Agent-Carter-T01EP02.php" class="text">Agent Carter T01EP02</a></li>
            <li><a href="Agent-Carter-T01EP03.php" class="text">Agent Carter T01EP03</a></li>
            <li><a href="Agent-Carter-T01EP04.php" class="text">Agent Carter T01EP04</a></li>
            <li><a href="Agent-Carter-T01EP05.php" class="text">Agent Carter T01EP05</a></li>
            <li><a href="Agent-Carter-T01EP06.php" class="text">Agent Carter T01EP06</a></li>
            <li><a href="Agent-Carter-T01EP07.php" class="text">Agent Carter T01EP07</a></li>
            <li><a href="Agent-Carter-T01EP08.php" class="text">Agent Carter T01EP08</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
		 	<li><a href="Agent-Carter-T02EP01.php" class="text">Agent Carter T02EP01</a></li>
            <li><a href="Agent-Carter-T02EP02.php" class="text">Agent Carter T02EP02</a></li>
            <li><a href="Agent-Carter-T02EP03.php" class="text">Agent Carter T02EP03</a></li>
            <li><a href="Agent-Carter-T02EP04.php" class="text">Agent Carter T02EP04</a></li>
            <li><a href="Agent-Carter-T02EP05.php" class="text">Agent Carter T02EP05</a></li>
            <li><a href="Agent-Carter-T02EP06.php" class="text">Agent Carter T02EP06</a></li>
            <li><a href="Agent-Carter-T02EP07.php" class="text">Agent Carter T02EP07</a></li>
            <li><a href="Agent-Carter-T02EP08.php" class="text">Agent Carter T02EP08</a></li>
            <li><a href="Agent-Carter-T02EP09.php" class="text">Agent Carter T02EP09</a></li>
            <li><a href="Agent-Carter-T02EP10.php" class="text">Agent Carter T02EP10</a></li>
         	</ul></div>
		</div>
  </div>
  <!-- Footer Section -->
