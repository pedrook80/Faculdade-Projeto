...
<link href="css/bootstrap(preacher) eps.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="images/vsicon.png">
<title>Preacher T01EP05</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0B_I23Abnn9WIbWJQNFpUMklNbVU/preview?rel=0&autoplay=1" frameborder="0" width="500" class="cards" allowfullscreen></iframe>
        <h4>Preacher T01EP05</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
