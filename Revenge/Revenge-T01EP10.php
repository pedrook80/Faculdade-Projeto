...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0B1a_cz1j034SSkRSYXIwenozNnM/preview?rel=0&autoplay=1" width="500" class="cards" frameborder="0" allowfullscreen ></iframe>
        <h4>Revenge T01EP10</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
