...
<title>Um Drink Inferno</title>
<link href="css/bootstrap(um-drink).css" rel="stylesheet" type="text/css">
</head>
<body>	
<!-- Main Container -->
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Um-Drink-No-Inferno.php"><img src="images/um-drink-no-inferno.jpg" alt="" width="2000" class="cards"/></a>
      	<h4>UM DRINK NO INFERNO</h4>
      	<p class="tag">O ladrão de bancos Seth Gecko (D.J. Cotrona) e seu imprevisível e violento irmão, Richard (Zane Holtz), são procurados pelo FBI e pelos Texas Rangers, a força policial do  estado do Texas. Em fuga para o México, eles encontram o ex-ministro Jacob Fuller (Robert Patrick) e sua família, e os fazem de reféns. Em posse do trailer dos Fuller, eles cruzam a fronteira e deparam com o caos quando entram em um clube de strip-tease que está cheio de vampiros. Agora eles são forçados a lutar até o amanhecer para poderem sair de lá vivos.</p>
      	<p>Criado por: Robert Rodriguez (2014) </p>
		<p>Gênero: Terror, Ação</p>
		<p>País: EUA</p>
		<p>Atores: D.J. Cotrona, Zane Holtz, Jesse Garcia mais...</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Um Drink No Inferno T01EP01</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T01EP02</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T01EP03</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T01EP04</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T01EP05</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T01EP06</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T01EP07</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T01EP08</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T01EP09</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T01EP10</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="#" class="text">Um Drink No Inferno T02EP01</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T02EP02</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T02EP03</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T02EP04</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T02EP05</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T02EP06</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T02EP07</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T02EP08</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T02EP09</a></li>
            <li><a href="#" class="text">Um Drink No Inferno T02EP10</a></li>
                </ul></div></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
