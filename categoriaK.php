...
<div class="corp"><div align="center" class="center"><img src="images/logo2.png"/></div>
 <div class="container">
    ...
    <nav id="menu" class="container">
      <ul id="menu-top-menu" class="sf-menu">
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="categoriaK" selected="selected">Categoria K</option>
  ...
  <div class="gallery">
    <div class="thumbnail" id="thumbnail10"><a href=""><img src="images/kingdom.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="">KINGDOM</a></h4>
      <p class="tag">Alvey (Frank Grillo) e Lisa (Kiele Sanchez) lutam para manter a academia Navy Street funcionando. A maior esperança que eles têm é Nate (Nick Jonas), filho de Alvey, aspirante<a href="#">Mais ...</a></p>
    </div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
