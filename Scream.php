...
<title>Scream</title>
<link href="css/bootstrap(scream).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
 ...
 <div class="gallery">
    <div class="thumbnail"><a href="Scream.php"><img src="images/scream.jpg" alt="" width="2000" class="cards"/></a>
      <h4>SCREAM</h4>
      <p class="tag">Depois de um incidente de cyber-bullying resultar em um assassinato brutal, a violência reacende a memória de uma série de assassinatos que ocorreram no passado em Lakewood, que intrigaram alguns e talvez tenham inspirado um novo serial killer. Um grupo de adolescentes, com dois velhos amigos tentando se reconectarem, se tornam amantes, inimigos, suspeitos, alvos e vítimas de um assassino que está à procura de sangue.</p>
      	<p>Criado por: Dan Dworkin, Jay Beattie (2015)</p>
		<p>Gênero: Drama, Terror</p>
		<p>País: EUA</p>
		<p>Atores: Willa Fitzgerald, Bex Taylor-Klaus, John Karna, mais ...</p>
        ...
        <!--<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Scream T01EP01</a></li>
            <li><a href="#" class="text">Scream T01EP02</a></li>
            <li><a href="#" class="text">Scream T01EP03</a></li>
            <li><a href="#" class="text">Scream T01EP04</a></li>
            <li><a href="#" class="text">Scream T01EP05</a></li>
            <li><a href="#" class="text">Scream T01EP06</a></li>
            <li><a href="#" class="text">Scream T01EP07</a></li>
            <li><a href="#" class="text">Scream T01EP08</a></li>
            <li><a href="#" class="text">Scream T01EP09</a></li>
            <li><a href="#" class="text">Scream T01EP10</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="#" class="text">Scream T02EP01</a></li>
            <li><a href="#" class="text">Scream T02EP02</a></li>
            <li><a href="#" class="text">Scream T02EP03</a></li>
            <li><a href="#" class="text">Scream T02EP04</a></li>
            <li><a href="#" class="text">Scream T02EP05</a></li>
            <li><a href="#" class="text">Scream T02EP06</a></li>
            <li><a href="#" class="text">Scream T02EP07</a></li>
            <li><a href="#" class="text">Scream T02EP08</a></li>
            <li><a href="#" class="text">Scream T02EP09</a></li>
            <li><a href="#" class="text">Scream T02EP10</a></li>
			</ul></div>--></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
