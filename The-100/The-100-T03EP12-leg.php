...
<title>The 100 T03EP12 (legendado)</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0B-6ZkAXfw1foSUV1UVNLYjl0TW8/preview?rel=0&autoplay=1" width="500" class="cards" allowfullscreen></iframe>
        <h4>The 100 T03EP12 <strong style="color:red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
