...
<title>The 100 T04EP04 LEGENDADO</title>
<script>
...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       		<video class="afterglow" id="myvideo" poster="images/The 100 3.jpg" width="500" height="250" data-autoresize="fit" src="http://cdnv4.ec.cx/RedeCanais/RedeCanais/RCServer11/ondemand/THE100S04EP04.mp4" type="video/mp4" data-quality="hd"></video>
        <h4>The 100 T04EP04 <strong style="color: red">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
