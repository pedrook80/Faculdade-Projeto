...
<title>Devious Maids</title>
<link href="css/bootstrap(devious-maids).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Devious-Maids.php"><img src="images/devious-maids.jpg" alt="" width="2000" class="cards"/></a>
      <h4>DEVIOUS MAIDS</h4>
      <p class="tag">Elas lavam as roupas que não podem comprar, dão polimento à prataria que nunca usarão e, algumas vezes, vão para a cama com os maridos de suas chefes. Tudo pode acontecer em um dia de trabalho das empregadas de Beverly Hills, mulheres constantemente rodeadas de riqueza e privilégio, que farão de tudo para chegar aos seus objetivos.</p>
      <p class="text_column2">Criado por: Marc Cherry (2013))</p>
      <p class="text_column2">Gênero: Drama, Novela</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Ana Ortiz, Dania Ramirez, Roselyn , mais ...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
		...
		<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Devious Maids T01EP01</a></li>
            <li><a href="#" class="text">Devious Maids T01EP02</a></li>
            <li><a href="#" class="text">Devious Maids T01EP03</a></li>
            <li><a href="#" class="text">Devious Maids T01EP04</a></li>
            <li><a href="#" class="text">Devious Maids T01EP05</a></li>
            <li><a href="#" class="text">Devious Maids T01EP06</a></li>
            <li><a href="#" class="text">Devious Maids T01EP07</a></li>
            <li><a href="#" class="text">Devious Maids T01EP08</a></li>
            <li><a href="#" class="text">Devious Maids T01EP09</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="#" class="text">Devious Maids T02EP01</a></li>
            <li><a href="#" class="text">Devious Maids T02EP02</a></li>
            <li><a href="#" class="text">Devious Maids T02EP03</a></li>
            <li><a href="#" class="text">Devious Maids T02EP04</a></li>
            <li><a href="#" class="text">Devious Maids T02EP05</a></li>
            <li><a href="#" class="text">Devious Maids T02EP06</a></li>
            <li><a href="#" class="text">Devious Maids T02EP07</a></li>
            <li><a href="#" class="text">Devious Maids T02EP08</a></li>
            <li><a href="#" class="text">Devious Maids T02EP09</a></li>
                </ul></div>
			<h3 class="heading"><span>3ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="#" class="text">Devious Maids T03EP01</a></li>
            <li><a href="#" class="text">Devious Maids T03EP02</a></li>
            <li><a href="#" class="text">Devious Maids T03EP03</a></li>
            <li><a href="#" class="text">Devious Maids T03EP04</a></li>
            <li><a href="#" class="text">Devious Maids T03EP05</a></li>
            <li><a href="#" class="text">Devious Maids T03EP06</a></li>
            <li><a href="#" class="text">Devious Maids T03EP07</a></li>
            <li><a href="#" class="text">Devious Maids T03EP08</a></li>
            <li><a href="#" class="text">Devious Maids T03EP09</a></li>
            </ul></div>
            <h3 class="heading"><span>4ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="#" class="text">Devious Maids T04EP01</a></li>
            <li><a href="#" class="text">Devious Maids T04EP02</a></li>
            <li><a href="#" class="text">Devious Maids T04EP03</a></li>
            <li><a href="#" class="text">Devious Maids T04EP04</a></li>
            <li><a href="#" class="text">Devious Maids T04EP05</a></li>
            <li><a href="#" class="text">Devious Maids T04EP06</a></li>
            <li><a href="#" class="text">Devious Maids T04EP07</a></li>
            <li><a href="#" class="text">Devious Maids T04EP08</a></li>
            <li><a href="#" class="text">Devious Maids T04EP09</a></li>
            </ul></div></div>
	</div>
  <!-- Footer Section -->
  <footer id="contact">
