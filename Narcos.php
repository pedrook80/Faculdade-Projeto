...
<title>Narcos</title>
<link href="css/bootstrap(narcos).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Narcos.php"><img src="images/narcos.jpg" alt="" width="2000" class="cards"/></a>
      <h4>NARCOS</h4>
      <p class="tag">A trama gira em torno do traficante Pablo Escobar (Wagner Moura), retratando a história de ascensão dele de um criminoso comum para um dos homens mais perigosos, procurados e ricos do mundo.</p>
      	<p>Criado por: Chris Brancato, Eric Newman (2015)</p>
		<p>Gênero: Ação, Drama, Crime, Policial, Suspense</p>
		<p>País: EUA</p>
		<p>Atores: Wagner Moura, Pedro Pascal, Boyd Holbrook, mais ...Wagner Moura, Pedro Pascal, Boyd Holbrook, mais ...</p>
        ...
        <!--<h3 class="thumb22"><span>1ª Temporada</span></h3>
            ...
            <li><a href="#" class="text">Narcos T01EP01</a></li>
            <li><a href="#" class="text">Narcos T01EP02</a></li>
            <li><a href="#" class="text">Narcos T01EP03</a></li>
            <li><a href="#" class="text">Narcos T01EP04</a></li>
            <li><a href="#" class="text">Narcos T01EP05</a></li>
            <li><a href="#" class="text">Narcos T01EP06</a></li>
            <li><a href="#" class="text">Narcos T01EP07</a></li>
            <li><a href="#" class="text">Narcos T01EP08</a></li>
            <li><a href="#" class="text">Narcos T01EP09</a></li>
            <li><a href="#" class="text">Narcos T01EP10</a></li>
            </ul></div>
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li>Sem data de estreia</li>
            </ul></div>--></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
