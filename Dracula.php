...
<title>Dracula</title>
<link href="css/bootstrap(dracula).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><img src="images/dracula.jpg" alt="DRACULA" width="2000" class="cards"/>
      <h4>DRACULA</h4>
      <p class="tag">A série apresenta a chegada de Dracula (Jonathan Rhys Meyers) em Londres, passando-se por um empresário norte-americano que deseja levar a modernidade científica à Sociedade Vitoriana. Na verdade, o que ele deseja é executar sua vingança contra as pessoas que arruinaram sua vida séculos antes. Apenas uma coisa pode estragar seus planos: Dracula se apaixona perdidamente por uma mulher que parece ser a reencarnação de sua falecida esposa.</p>
      <p class="text_column2">Criado por: Cole Haddon, Tony Krantz (2013)</p>
      <p class="text_column2">Gênero: Drama, Fantasia</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Jonathan Rhys Meyers, Jessica De, mais ...</p>
      <p class="text_column2">Status: Finalizada</p>
      <p class="text_column2">Duração: 42 minutos</p>
		<div class="ver"></div>
		<h3><span style="color:red">EM BREVE</span></h3>
		<!--<h3 class="thumb22"><span>1ª Temporada</span></h3>
			<div id="epsetemps">
        		<ul class="temps" id="temp1">
            <li><a href="Dracula-T01EP01.php" class="text">Dracula T01EP01</a></li>
            <li><a href="Dracula-T01EP02.php" class="text">Dracula T01EP02</a></li>
            <li><a href="Dracula-T01EP03.php" class="text">Dracula T01EP03</a></li>
            <li><a href="Dracula-T01EP04.php" class="text">Dracula T01EP04</a></li>
            <li><a href="Dracula-T01EP05.php" class="text">Dracula T01EP05</a></li>
            <li><a href="Dracula-T01EP06.php" class="text">Dracula T01EP06</a></li>
            <li><a href="Dracula-T01EP07.php" class="text">Dracula T01EP07</a></li>
            <li><a href="Dracula-T01EP08.php" class="text">Dracula T01EP08</a></li>
            <li><a href="Dracula-T01EP09.php" class="text">Dracula T01EP09</a></li>
            <li><a href="Dracula-T01EP10.php" class="text">Dracula T01EP10</a></li>
</ul></div>--></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
