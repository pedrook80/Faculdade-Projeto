...
<link href="css/bootstrap(bates).css" rel="stylesheet" type="text/css">
...
<div class=" menu-item-43">
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Bates-Motel.php"><img src="images/bates-motel.jpg" alt="" width="2000" class="cards"/></a>
      <h4>BATES MOTEL</h4>
      <p class="tag">Após a misteriosa morte de seu marido, Norma Bates decidiu começar uma nova vida longe do Arizona, na pequena cidade de White Pine Bay, em Oregon, e leva o filho Norman, de 17 anos, com ela. Ela comprou um velho motel abandonado e a mansão ao lado. Mãe e filho sempre compartilharam uma relação complexa, quase incestuosa, e trágicos acontecimentos irão aproxima-los ainda mais. Todos eles agora compartilham um segredo obscuro.</p>
      <p class="text_column2">Criado por: Anthony Cipriano (2013)</p>
      <p class="text_column2">Gênero: Drama, Policial, Suspense</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Vera Farmiga, Freddie Highmore, Max Thieriot, mais ...</p>
      ...
      <p class="text_column2">Duração: 42 minutos</p>
        ...
        <h3 class="thumb22"><span>1ª Temporada</span></h3>
			...
			<li><a href="Bates-Motel-T01EP01.php" class="text">Bates Motel T01EP01</a></li>
            <li><a href="Bates-Motel-T01EP02.php" class="text">Bates Motel T01EP02</a></li>
            <li><a href="Bates-Motel-T01EP03.php" class="text">Bates Motel T01EP03</a></li>
            <li><a href="Bates-Motel-T01EP04.php" class="text">Bates Motel T01EP04</a></li>
            <li><a href="Bates-Motel-T01EP05.php" class="text">Bates Motel T01EP05</a></li>
            <li><a href="Bates-Motel-T01EP06.php" class="text">Bates Motel T01EP06</a></li>
            <li><a href="Bates-Motel-T01EP07.php" class="text">Bates Motel T01EP07</a></li>
            <li><a href="Bates-Motel-T01EP08.php" class="text">Bates Motel T01EP08</a></li>
            <li><a href="Bates-Motel-T01EP09.php" class="text">Bates Motel T01EP09</a></li>
            <li><a href="Bates-Motel-T01EP10.php" class="text">Bates Motel T01EP10</a></li>
            </ul></div>
            
		<h3 class="heading"><span>2ª Temporada</span></h3>
			<div id="temp2">
			<ul id="lista_eps2">
     		<li><a href="Bates-Motel-T02EP01.php" class="text">Bates Motel T02EP01</a></li>
            <li><a href="Bates-Motel-T02EP02.php" class="text">Bates Motel T02EP02</a></li>
            <li><a href="Bates-Motel-T02EP03.php" class="text">Bates Motel T02EP03</a></li>
            <li><a href="Bates-Motel-T02EP04.php" class="text">Bates Motel T02EP04</a></li>
            <li><a href="Bates-Motel-T02EP05.php" class="text">Bates Motel T02EP05</a></li>
            <li><a href="Bates-Motel-T02EP06.php" class="text">Bates Motel T02EP06</a></li>
            <li><a href="Bates-Motel-T02EP07.php" class="text">Bates Motel T02EP07</a></li>
            <li><a href="Bates-Motel-T02EP08.php" class="text">Bates Motel T02EP08</a></li>
            <li><a href="Bates-Motel-T02EP09.php" class="text">Bates Motel T02EP09</a></li>
            <li><a href="Bates-Motel-T02EP10.php" class="text">Bates Motel T02EP10</a></li>
            </ul></div>
			<h3 class="thumb22">3ª e 4ª Temporada <span style="color:red">EM BREVE</span></h3>
			<!--<h3 class="heading"><span>3ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="#" class="text">Bates Motel T03EP01</a></li>
            <li><a href="#" class="text">Bates Motel T03EP02</a></li>
            <li><a href="#" class="text">Bates Motel T03EP03</a></li>
            <li><a href="#" class="text">Bates Motel T03EP04</a></li>
            <li><a href="#" class="text">Bates Motel T03EP05</a></li>
            <li><a href="#" class="text">Bates Motel T03EP06</a></li>
            <li><a href="#" class="text">Bates Motel T03EP07</a></li>
            <li><a href="#" class="text">Bates Motel T03EP08</a></li>
            <li><a href="#" class="text">Bates Motel T03EP09</a></li>
            <li><a href="#" class="text">Bates Motel T03EP10</a></li>
            </ul></div>
            <h3 class="heading"><span>4ª Temporada</span></h3>
            <div>
            <ul>
			<p><a class="text2"></a></p>
            <li><a href="#" class="text">Bates Motel T04EP01</a></li>
            <li><a href="#" class="text">Bates Motel T04EP02</a></li>
            <li><a href="#" class="text">Bates Motel T04EP03</a></li>
            <li><a href="#" class="text">Bates Motel T04EP04</a></li>
            <li><a href="#" class="text">Bates Motel T04EP05</a></li>
            <li><a href="#" class="text">Bates Motel T04EP06</a></li>
            <li><a href="#" class="text">Bates Motel T04EP07</a></li>
            <li><a href="#" class="text">Bates Motel T04EP08</a></li>
            <li><a href="#" class="text">Bates Motel T04EP09</a></li>
            <li><a href="#" class="text">Bates Motel T04EP10</a></li>
            </ul></div>--></div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
