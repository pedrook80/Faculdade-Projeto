...
<!-- Main Container -->
 ...
 <div class="container"> 
    ...
    <nav id="menu" class="container">
      <ul id="menu-top-menu" class="sf-menu">
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="categoriaL" selected="selected">Categoria L</option>
  ...
  <div class="gallery">
    <div class="thumbnail"><a href="Lucifer.php"><img src="images/lucifer.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="Lucifer.php">LUCIFER</a></h4>
      <p class="tag">Entediado e infeliz como o Senhor do inferno, Lúcifer abdica de seu trono e abandona seu reinado para viver na atordoada Los Angeles. Lá, ele dá início a outro empreendimento<a href="Lucifer">Mais ...</a></p>
    </div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
