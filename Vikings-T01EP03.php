...
<div class="container"> 
  ...
  <div class="gallery">
    ...
    <ul id="options1"><li><a href="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP03.mp4?rel=0&autoplay=1" target="video1"> OPÇÃO 2 </a></li></ul></div>
  	<div class="thumbnail">
        ...
        <video class="afterglow" id="myvideo" width="700" height="400" data-autoresize="fit">
      		<source type="video/mp4" src="https://redirector.googlevideo.com/videoplayback?requiressl=yes&id=252fd0b967572af2&itag=18&source=blogger&app=blogger&cmo=secure_transport%3Dyes&cmo=sensitive_content%3Dyes&ip=0.0.0.0&ipbits=0&expire=1487609845&sparams=requiressl,id,itag,source,ip,ipbits,expire&signature=8FA873849961D0415890D4602646B79C5591DD07.5FBC66C17DAE7913AC14984A29EA1EF14B03ACD1&key=ck2"/>
      		<source type="video/mp4" src="http://vd.ec.cx/vd/dd/RC/RCServer05/ondemand/VKGST01EP03.mp4" data-quality="hd"/>
		</video>
        <h4>Vikings T01EP03</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
